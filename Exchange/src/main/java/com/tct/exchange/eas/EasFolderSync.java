...
import com.tct.exchange.adapter.FolderSyncParser;
...
public class EasFolderSync extends EasOperation {
    ...
    private void writeResultCode(final Bundle bundle, final int resultCode) {
        ...
        switch (resultCode) {
            ...
            case RESULT_CERTIFICATE_VALIDATE_ERROR:
                messagingExceptionCode = MessagingException.CERTIFICATE_VALIDATION_ERROR;
                break;
            // TS: zhaotianyong 2014-01-09 EXCHANGE BUGFIX-890079 ADD_S
            default:
                messagingExceptionCode = MessagingException.UNSPECIFIED_EXCEPTION;
