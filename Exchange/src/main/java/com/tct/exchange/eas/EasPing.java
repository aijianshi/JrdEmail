 ...
 *============== ============ =============== =======================================================================
 *BUGFIX-1015782  2015/06/02   jin.dong     [ALT][Email]Can't sync email and consumption heavy
 ====================================================================================================================
 */
...
public class EasPing extends EasOperation {
    ...
    private void requestFolderSync() {
        //TS: jin.dong 2015-06-02 EMAIL BUGFIX_1015782 MOD_S
        //note: add SYNC_EXTRAS_EXPEDITED and SYNC_EXTRAS_IGNORE_SETTINGS to make sure the folderSync is performed without delay
        final Bundle extras = new Bundle(3);
        extras.putBoolean(ContentResolver.SYNC_EXTRAS_IGNORE_SETTINGS, true);
        extras.putBoolean(ContentResolver.SYNC_EXTRAS_EXPEDITED, true);
        //TS: jin.dong 2015-06-02 EMAIL BUGFIX_1015782 MOD_E
