...
public class EasAutoDiscover extends EasOperation {
    ...
    public final static int ATTEMPT_MAX = 1; //TS: yang.mei 2016-04-11 EMAIL BUGFIX_1921223 MOD
    ...
    protected HttpUriRequest makeRequest() throws IOException, MessageInvalidException {
        ...
        //TS: yang.mei 2016-04-11 EMAIL BUGFIX_1921223 MOD_S
        ...
        //TS: yang.mei 2016-04-11 EMAIL BUGFIX_1921223 MOD_E
        return req;
    }
    ...
    //[BUGFIX]-Add-BEGIN by TSNJ Zhenhua.Fan,10/27/2014,PR 719562
    public String getRequestContentType() {
        // The Autodiscover command request and response messages are sent in XML format, not WBXML format
        return AUTODISCOVER_CONTENT_TYPE; //TS: yang.mei 2016-04-11 EMAIL BUGFIX_1921223 MOD
    }
