...
import com.tct.exchange.eas.EasProvision;
        ...
        while (nextTag(Tags.PROVISION_EAS_PROVISION_DOC) != END) {
            ...
            switch (tag) {
                ...
                case Tags.PROVISION_ALLOW_SIMPLE_DEVICE_PASSWORD:
                    // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 MOD_S
...
//                    getValue();
                    policy.mDisallowSimpleDevicePassword = (getValueInt() == 0);
                    // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 MOD_E
                    break;
