...
import com.tct.exchange.eas.EasSyncCollectionTypeBase;
...
public class ContactsSyncParser extends AbstractSyncParser {
    ...
    private static final String FOUND_DATA_ROW = "com.tct.exchange.FOUND_ROW";
    ...
    public void commit() throws IOException {
        ...
        if (!PermissionUtil.checkPermissionAndLaunchExplain(mContext, Manifest.permission.WRITE_CONTACTS)) {
            LogUtils.e(LogUtils.TAG, "permission %s needed in ContactSyncParser commit()", Manifest.permission.READ_CONTACTS);
            return;
        }
