 ...
 *TASK-869664    2015/11/27    zheng.zou      [Email]Android M Permission Upgrade
 ============================================================================
 */
package com.tct.exchange.utility;
...
public class CalendarUtilities {
    ...
    static public long createCalendar(final Context context, final ContentResolver contentResolver,
        ...
        if (!PermissionUtil.checkPermissionAndLaunchExplain(context, Manifest.permission.WRITE_CALENDAR)){
            LogUtils.i(PermissionUtil.TAG,"permission %s needed in createCalendar()", Manifest.permission.WRITE_CALENDAR);
            return -1;
        }
    ...
    static public EmailContent.Message createMessageForEventId(Context context, long eventId,
        ...
        if (!PermissionUtil.checkPermissionAndLaunchExplain(context, Manifest.permission.READ_CALENDAR)){
            LogUtils.i(PermissionUtil.TAG,"permission %s needed in createMessageForEventId()", Manifest.permission.READ_CALENDAR);
            return null;
        }
