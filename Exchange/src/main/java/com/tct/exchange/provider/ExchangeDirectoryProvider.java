 ...
 *============== ============ =============== ==============================================================
 *BUGFIX-941608  2015-03-11   zhonghua.tuo     [stability]Exchange error in vA63.
 ===========================================================================================================
 */

package com.tct.exchange.provider;
...
import com.tct.emailcommon.Configuration;
...
import com.tct.exchange.provider.GalResult.GalData;
...
public class ExchangeDirectoryProvider extends ContentProvider {
    ...
    public static final String EXCHANGE_GAL_AUTHORITY =
            com.tct.exchange.Configuration.EXCHANGE_GAL_AUTHORITY;
        ...
        switch (match) {
            ...
            case GAL_EMAIL_FILTER: {
                ...
                try {
                    ...
                    //TS: zhonghua.tuo 2015-03-11 EMAIL BUGFIX_-941608 MOD_S
                    GalResult galResult = null;
                    if(!ActivityManager.isUserAMonkey()){
                        galResult = EasService.searchGal(getContext(), accountId,filter, queryLimit);
                    }
                    //TS: zhonghua.tuo 2015-03-11 EMAIL BUGFIX_-941608 MOD_E
