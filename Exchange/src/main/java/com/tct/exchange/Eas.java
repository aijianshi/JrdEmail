...
public class Eas {
    ...
    public static final String EXCHANGE_ACCOUNT_MANAGER_TYPE =
            com.tct.exchange.Configuration.EXCHANGE_ACCOUNT_MANAGER_TYPE;
    public static final String PROTOCOL = com.tct.exchange.Configuration.EXCHANGE_PROTOCOL;
    public static final String EXCHANGE_SERVICE_INTENT_ACTION =
            com.tct.exchange.Configuration.EXCHANGE_SERVICE_INTENT_ACTION;
    ...
    //[FEATURE]-Add-BEGIN by TSCD.Chao Zhang,04/15/2014,FR 631895(porting from FR 472914)
...
//    public static final int MAILBOX_TYPE_RECIPIENT_INFORMATION_CACHE = 19;
     ...
     */
    public static final String EAS2_5_TRUNCATION_SIZE_0 = "0";
    public static final String EAS2_5_TRUNCATION_SIZE_1 = "1";
    public static final String EAS2_5_TRUNCATION_SIZE_2 = "2";
    public static final String EAS2_5_TRUNCATION_SIZE_3 = "3";
    public static final String EAS2_5_TRUNCATION_SIZE_4 = "4";
    public static final String EAS2_5_TRUNCATION_SIZE_5 = "5";
    public static final String EAS2_5_TRUNCATION_SIZE_6 = "6";
    public static final String EAS2_5_TRUNCATION_SIZE_7 = "7";
    public static final String EAS2_5_TRUNCATION_SIZE_8 = "8";
