 ...
 *============== ============ =============== ==============================
 *BUGFIX-1027618  2015/12/3   zhangchao     [Android L][Email][Monkey][Crash]java.lang.OutOfMemoryError happened during monkey test
 *============================================================================
 */
...
public class EasResponse {
    ...
    public static EasResponse fromHttpRequest(
        ...
        //NOTE:When execute HTTP request,it must create the buffer connection such as InputStream or outputStream
        //So memory is needed,but during low memory condition,system CAN NOT allocate enough memory and OOM happen
        //Here just catch it and make  APP not CRASH.
        try {
            final HttpResponse response = client.execute(request);
            return new EasResponse(response, connManager, reqTime);
        } catch (OutOfMemoryError oom) {
            LogUtils.e(LogUtils.TAG, "OutOfMemoryError happen during do HTTP request in EasResponse:" + oom);
            throw new IOException("OutOfMemoryError happen when get response,just thrown IOException,DO NOT crash the Exchange app");
        }
    }
    ...
    //TS: yang.mei 2016-04-11 EMAIL BUGFIX_1921223 ADD_S
    /**
    ...
    //TS: yang.mei 2016-04-11 EMAIL BUGFIX_1921223 ADD_E
