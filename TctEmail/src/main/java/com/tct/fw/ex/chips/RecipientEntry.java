...
public class RecipientEntry {
    ...
    protected RecipientEntry(int entryType, String displayName, String destination,
        ...
        mDisplayName = Rfc822Validator.fixInvalidName(displayName);
        ...
        mPhotoBytes = null;
        mIsDivider = false;
        //TS: junwei-xu 2016-01-29 EMAIL BUGFIX-1503251 MOD_S
        //Note: must check the destination whether it is valid.
        mIsValid = isValid && Rfc822Validator.isAddressValid(destination);
        //TS: junwei-xu 2016-01-29 EMAIL BUGFIX-1503251 MOD_E
    ...
    public boolean isSameRecipient(final RecipientEntry entry) {
        if (entry == null) return false;
        Rfc822Token current = new Rfc822Token(mDestination, mDisplayName, null);
        Rfc822Token compare = new Rfc822Token(entry.mDestination, entry.mDisplayName, null);
        return current.toString().equalsIgnoreCase(compare.toString());
    }
