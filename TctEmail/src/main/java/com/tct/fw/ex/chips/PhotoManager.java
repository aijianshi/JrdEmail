...
/**
 * Used by the {@link com.tct.fw.ex.chips.BaseRecipientAdapter} to handle fetching
...
public interface PhotoManager {
    ...
    /**
     * Sets the {@link com.tct.fw.ex.chips.RecipientEntry}'s photo bytes. If the photo bytes
