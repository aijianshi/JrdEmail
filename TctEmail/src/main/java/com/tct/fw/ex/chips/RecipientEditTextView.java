...
*============== ============ =============== =======================================================================
*BUGFIX-853226 2014/12/03 wenggangjin [Android5.0][Email]The screen will jump when input email addresses
*BUGFIX-860174 2014/12/8  junwei-xu   [Android5.0][Email]The recipient address displays at right of To field
*BUGFIX-882460 2015/01/13 chenyanhua  [Email]Sometimes input point in To/Cc/Bcc fields will add the same address repeatedly
*BUGFIX-894492 2015/02/03 chenyanhua  [Android5.0][Email][UI]No dividing line when tapping a recipient with several mail addresses
*BUGFIX-921047 2015/02/04 chenyanhua  [Android 5.0][Email]The edge of red box isn't smooth
*BUGFIX-927991 2015/02/015 zheng.zou  [Android5.0][Contacts_v5.1.4.1.0001.0]Contacts head portrait icon can't show when adding one contact in the email
...
*BUGFIX-940683  2015/03/13   zhichuan.wei    [Scenario Test][Email]Add contact function abnormal display abnormal.
*BUGFIX-955981  2015/03/23   zhichuan.wei    [[Android5.0][Email][REG]Only show 2 last address when we input more than 2 addresses
*BUGFIX-939948  2015/03/24   qing.liang      [Scenario Test][Email][monitor]Have a red icon in bcc bar after delete email address
*BUGFIX-948927  2015/03/27   zheng.zou       [Monitor][Email]Email Force Close after edit draft sometimes
*BUGFIX-969666  2015/04/08   zhonghua.tuo    [Android5.0][Email][Force Close]Email FC when tap contact in the to field constantly
*BUGFIX-969797  2015/07/02   xujian          [Android5.0][Email]Email address will be copied when double click it
*BUGFIX-1047817 2015/07/20   jin.dong        [GAPP][Monitor][FC][Email]Appear Email FC when edit email from outbox
*BUGFIX-1074922 2015/08/26   jian.xu         [Monkey][Email][Force close] com.tct.email force close during Monkey test
*BUGFIX-575457  2015/12/11   junwei-xu       [Android L][Email]Recipient input box abnormal
*BUGFIX-1503251 2016/01/29   junwei-xu       [Email]The invaild address will display as vaild after tap them in landscape mode
*BUGFIX-1527821 2016-01-31   jian.xu         [Email]Some recipients will disappear after rotate the phone.
*BUGFIX-1469249 2016-02-02   junwei-xu       [Android][Email]recipient input boxes are abnormal
 *BUGFIX-1843587 2016-03-21   tao.gan        [Android M][Email][Monkey][Crash][Monitor]java.lang.StringIndexOutOfBoundsException during monkey test
*BUGFIX-1863457 2016/03/28   rong-tang       [Email]The number of receivers is incorrect when reply all.
*BUGFIX-1886644 2016/04/11   rong-tang       [Email] When adding two or more contacts to a reply all email with three or more email address in the To field, only one email address gets added.
*BUGFIX-1924305 2016-04-12   junwei-xu       [Email]It displays incorrect when adding all contacts to recipients on reply all interface
 ====================================================================================================================
*/
package com.tct.fw.ex.chips;
...
//TS: chenyanhua 2015-02-04 EMAIL BUGFIX-921047 ADD_S
import android.graphics.PaintFlagsDrawFilter;
//TS: chenyanhua 2015-02-04 EMAIL BUGFIX-921047 ADD_E
...
import com.tct.fw.ex.chips.RecipientAlternatesAdapter.RecipientMatchCallback;
import com.tct.fw.ex.chips.recipientchip.DrawableRecipientChip;
import com.tct.fw.ex.chips.recipientchip.InvisibleRecipientChip;
import com.tct.fw.ex.chips.recipientchip.ReplacementDrawableSpan;
import com.tct.fw.ex.chips.recipientchip.VisibleRecipientChip;
import com.tct.fw.R;
...
public class RecipientEditTextView extends MultiAutoCompleteTextView implements
    ...
    //TS: zhonghua.tuo 2015-4-08 EMAIL BUGFIX_969666 ADD_S
    private int mBottomOffset = 0;
    //TS: zhonghua.tuo 2015-4-08 EMAIL BUGFIX_969666 ADD_E
    ...
    public RecipientEditTextView(Context context, AttributeSet attrs) {
        ...
        mAlternatesListener = new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView,View view, int position,
             ...
             // TS: xujian 2015-07-02 EMAIL BUGFIX-969797 MOD_S
                mHandler.sendMessageDelayed(delayed, 0);
             // TS: xujian 2015-07-02 EMAIL BUGFIX-969797 MOD_E
                clearComposingText();
            }
        };
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        // TS: Gantao 2015-11-30 EMAIL BUGFIX-988657 DEL_S
        //why set the actionLable? It will cause imeOptions show as "Return", fix it.
//        outAttrs.actionLabel = getContext().getString(R.string.action_label);
        // TS: Gantao 2015-11-30 EMAIL BUGFIX-988657 DEL_E
        return connection;
    }
     ...
     *
     */
    public void appendAll(CharSequence text) {
     ...
     *
     */
    public void postAppend(CharSequence text) {
    ...
    // TS: zhonghua.tuo 2015-03-05 EMAIL BUGFIX-938039 ADD_S
    /**
    ...
    public void append(CharSequence text, int start, int end) {
        //TS: jian.xu 2016-01-31 EMAIL BUGFIX-1527821 ADD-S
        //Note: Check repeat text, do not allow add repeat text.
        if (getText().toString().contains(text)) {
            return;
        }
        //TS: jian.xu 2016-01-31 EMAIL BUGFIX-1527821 ADD-E
    ...
    protected void scrollBottomIntoView() {
        if (mScrollView != null && mShouldShrink) {
            ...
            // content.
          //TS: wenggangjin 2014-12-03 EMAIL BUGFIX_853226 MOD_S
            int desiredPos = (int) mChipHeight + mActionBarHeight + getExcessTopPadding();
            if (currentPos > (desiredPos + mChipHeight)) {
                mScrollView.scrollBy(0, currentPos - desiredPos - ((int) mChipHeight) / 3);
            }
          //TS: wenggangjin 2014-12-03 EMAIL BUGFIX_853226 MOD_E
        }
    }
    ...
    private void shrink() {
        ...
        //[BUGFIX]-Add-BEGIN by TCTNJ.zhichuan.wei,03/13/2015,PR940683
        if(mMoreChip != null) {
            return;
        }
    ...
    private ChipBitmapContainer createChipBitmap(RecipientEntry contact, TextPaint paint,
        ...
        //TS: junwei-xu 2014-12-8 EMAIL BUGFIX_860174 MOD_S
        int iconWidth = (contact.isValid() && contact.getContactId() != RecipientEntry.INVALID_CONTACT) ?
                height - backgroundPadding.top - backgroundPadding.bottom : 0;
        //TS: junwei-xu 2014-12-8 EMAIL BUGFIX_860174 MOD_E
        ...
        //TS: junwei-xu 2014-12-8 EMAIL BUGFIX_860174 MOD_S
        final int startPadding = (contact.isValid() && contact.getContactId() != RecipientEntry.INVALID_CONTACT) ? mChipTextStartPadding : mChipTextEndPadding;
        //TS: junwei-xu 2014-12-8 EMAIL BUGFIX_860174 MOD_E
    ...
    private void loadAvatarIcon(final RecipientEntry contact,
        ...
        //TS: jian.xu 2016-01-31 EMAIL BUGFIX-1527821 MOD-S
        // Don't draw photos for recipients that contact id is invalid on the fly.
        long contactId = contact.getContactId();
        boolean drawPhotos = contactId != RecipientEntry.INVALID_CONTACT;
        //TS: jian.xu 2016-01-31 EMAIL BUGFIX-1527821 MOD-E
    ...
    /*package*/ void handlePendingChips() {
        ...
        synchronized (mPendingChips) {
            //TS: rong-tang 2016-04-11 EMAIL BUGFIX-1886644 ADD_S
            //Note: remove more chip before execute replace chip operation.
            removeMoreChip();
            //TS: rong-tang 2016-04-11 EMAIL BUGFIX-1886644 ADD_E
            Editable editable = getText();
            // Tokenize!
            if (mPendingChipsCount <= MAX_CHIPS_PARSED) {
                for (int i = 0; i < mPendingChips.size(); i++) {
                    ...
                    //TS: zheng.zou 2015-2-15 EMAIL BUGFIX_927991 ADD_S
                    //when invoke super.append(text, start, end), if the text contains special character, like "@#",
                    //some how double quote symbol is added, need to remove it to go on replace process.
                    if (tokenStart == -1 && editable.toString().contains("\"")) {
                        String content = editable.toString().replaceAll("\"", "");
                        tokenStart = content.indexOf(current);
                    }
                    //TS: zheng.zou 2015-2-15 EMAIL BUGFIX_927991 ADD_E
            ...
            if (mTemporaryRecipients != null && mTemporaryRecipients.size() > 0
                ...
                if (hasFocus() || mTemporaryRecipients.size() < CHIP_LIMIT) {
                    ...
                    //TS: rong-tang 2016-04-11 EMAIL BUGFIX-1886644 DEL_S
                    //Note: create more chip operation must execute after the whole chip replacement is done.
                    //createMoreChip();
                    //TS: rong-tang 2016-04-11 EMAIL BUGFIX-1886644 DEL_E
                }
            } else {
            ...
            //TS: rong-tang 2016-04-11 EMAIL BUGFIX-1886644 ADD_S
            //Note: create more chip after execute replace chip operation.
            createMoreChip();
            //TS: rong-tang 2016-04-11 EMAIL BUGFIX-1886644 ADD_E
    ...
    RecipientEntry createTokenizedEntry(final String token) {
        ...
        //TS: junwei-xu 2016-01-29 EMAIL BUGFIX-1503251 DEL_S
        //Note: no need to fix the invalid address, if it is invalid,
        //just let user modify it manually.
        /*
        ...
        */
        //TS: junwei-xu 2016-01-29 EMAIL BUGFIX-1503251 DEL_E
        return RecipientEntry.constructFakeEntry(token, isValid);
    }
    ...
    private boolean commitChip(int start, int end, Editable editable) {
        ...
        if (adapter != null && adapter.getCount() > 0 && enoughToFilter()
                && end == getSelectionEnd() && !isPhoneQuery()&&(end - start !=1)) {// TS: chenyanhua 2015-01-13 EMAIL BUGFIX_882460 MOD
            ...
            //TS: junwei-xu 2015-12-11 EMAIL BUGFIX-575457 ADD_S
            String editText = getText().toString();
            String text = "";
            if (editText.length() > start || editText.length() > end) {
                text = editText.substring(start, end).trim();
            }
            ...
            //TS: junwei-xu 2015-12-11 EMAIL BUGFIX-575457 ADD_E
            dismissDropDown();
            return true;
        } else {
    ...
    private void handleEdit(int start, int end) {
        ...
        Editable editable = getText();
        setSelection(end);
        // TS: qing.liang 2015-03-24 EMAIL BUGFIX-939948 MOD_S
        //note:the empty space can create a fake chip that appears like a red dot
//        String text = getText().toString().substring(start, end);
        String text = getText().toString().substring(start, end).trim();
        // TS: qing.liang 2015-03-24 EMAIL BUGFIX-939948 MOD_E
        if (!TextUtils.isEmpty(text)) {
            RecipientEntry entry = RecipientEntry.constructFakeEntry(text, isValid(text));
            QwertyKeyListener.markAsReplaced(editable, start, end, "");
            CharSequence chipText = createChip(entry, false);
            ...
            if (currentChip != null) {
                if (action == MotionEvent.ACTION_UP) {
                    if (mSelectedChip != null && mSelectedChip != currentChip) {
                        ...
                        mBottomOffset = calculateOffsetFromBottomToTop(line);
                        //TS: zhonghua.tuo 2015-4-08 EMAIL BUGFIX_969666 ADD_E
    ...
    private void showAlternates(final DrawableRecipientChip currentChip,
        ...
        new AsyncTask<Void, Void, ListAdapter>() {
            ...
            protected void onPostExecute(final ListAdapter result) {
                ...
                int bottomOffset = mBottomOffset;
                //TS: zhonghua.tuo 2015-4-08 EMAIL BUGFIX_969666 ADD_E
    ...
    private ListAdapter createAlternatesAdapter(DrawableRecipientChip chip) {
        // TS: jian.xu 2015-08-26 EMAIL BUGFIX-1074922 MOD_S
        String currentAddress = "";
        // TS: chenyanhua 2015-02-03 EMAIL BUGFIX-894492 ADD_S
        String chipStr = chip.getEntry().toString();
        //String currentAddress = chipStr.substring(chipStr.indexOf("<")+1, chipStr.indexOf(">"));
        int start = chipStr.indexOf("<") + 1;
        int end = chipStr.indexOf(">");
        if (start >= 0 && start <= end && end <= chipStr.length()) {
            currentAddress = chipStr.substring(start, end);
        } else {
            Log.d(TAG, "The chip string is incorrect: "+chipStr);
        }
        // TS: chenyanhua 2015-02-03 EMAIL BUGFIX-894492 ADD_E
        // TS: jian.xu 2015-08-26 EMAIL BUGFIX-1074922 MOD_E
        return new RecipientAlternatesAdapter(getContext(), chip.getContactId(),
                ...
                constructStateListDeleteDrawable(), currentAddress);// TS: chenyanhua 2014-02-03 EMAIL BUGFIX_894492 MOD
    }
    ...
    private StateListDrawable constructStateListDeleteDrawable() {
        ...
        //TS: Gantao 2015-12-04 EMAIL BUGFIX_1039061 MOD_S
        try {
            if (!mDisableDelete) {
                deleteDrawable.addState(new int[]{android.R.attr.state_activated}, mChipDelete);
                deleteDrawable.addState(new int[]{android.R.attr.state_enabled}, mChipDelete);//zhiqiang.shao 2015-03-30 EMAIL BUGFIX_961183
            }
            deleteDrawable.addState(new int[0], null);
        } catch (Exception e) {
            LogUtils.e(TAG, "Occur exception while construct state list drawable");
        }
        //TS: Gantao 2015-12-04 EMAIL BUGFIX_1039061 MOD_E
    ...
    private int submitItemAtPosition(int position) {
        ...
        QwertyKeyListener.markAsReplaced(editable, start, end, "");
        //TS: jian.xu 2016-01-31 EMAIL BUGFIX-1527821 MOD-S
        //Note: do not allow add repeat entry.
        if (alreadyHasRecipientEntry(entry)) {
    ...
    /*package*/ void createMoreChipPlainText() {
        //TS: junwei-xu 2016-04-12 EMAIL BUGFIX-1924305 ADD_S
        //Note: must remove the spans created before.
        ...
        //TS: junwei-xu 2016-04-12 EMAIL BUGFIX-1924305 ADD_E
    ...
    /* package */ void createMoreChip() {
        //TS: rong-tang 2016-03-28 EMAIL BUGFIX-1863457 ADD_S
        //Note: before create more chip, must remove the previous more chip if it is exist.
        removeMoreChip();
        //TS: rong-tang 2016-03-28 EMAIL BUGFIX-1863457 ADD_E
        if (mNoChips) {
            createMoreChipPlainText();
            return;
        }
    ...
    private DrawableRecipientChip selectChip(DrawableRecipientChip currentChip) {
        if (shouldShowEditableText(currentChip)) {
            ...
            //TS: junwei-xu 2015-12-11 EMAIL BUGFIX-575457 MOD_S
            //Note: need delete the space char in last index.
            ...
            //TS: junwei-xu 2015-12-11 EMAIL BUGFIX-575457 MOD_E
            setCursorVisible(true);
    ...
    private void unselectChip(DrawableRecipientChip chip) {
        ...
        if (start == -1 || end == -1) {
            ...
            setSelection(editable.length());
            //TS: tao.gan 2016-03-21 EMAIL BUGFIX_1843587 MOD_S
            try {
                commitDefault();
            } catch (StringIndexOutOfBoundsException ex) {
                Log.e(TAG, ex.getMessage(), ex);
            }
            //TS: tao.gan 2016-03-21 EMAIL BUGFIX_1843587 MOD_E
        } else {
   ...
   public boolean lastCharacterIsCommitCharacter(CharSequence s) {
    ...
    private class RecipientReplacementTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            //TS: zheng.zou 2015-3-27 EMAIL BUGFIX_948927 ADD_S
            if (adapter == null) {
                return null;
            }
            //TS: zheng.zou 2015-3-27 EMAIL BUGFIX_948927 ADD_E
                        ...
                        public void matchesFound(Map<String, RecipientEntry> entries) {
                            ...
                            for (final DrawableRecipientChip temp : recipients) {
                                ...
                                if (temp != null && RecipientEntry.isCreatedRecipient(
                                    ...
                                    //TS: jian.xu 2016-01-31 EMAIL BUGFIX-1527821 MOD-S
                                    //Note: the map's key is "name + address"
                                    // Replace this.
                                    entry = createValidatedEntry(
                                            entries.get(createAddressText(temp.getEntry())));
                                    //TS: jian.xu 2016-01-31 EMAIL BUGFIX-1527821 MOD-E
                                }
                                if (entry != null) {
                        ...
                        public void matchesNotFound(final Set<String> unfoundAddresses) {
                            ...
                            for (final DrawableRecipientChip temp : recipients) {
                                if (temp != null && RecipientEntry.isCreatedRecipient(
                                        ...
                                        && getSpannable().getSpanStart(temp) != -1) {
                                    //TS: jian.xu 2016-01-31 EMAIL BUGFIX-1527821 MOD-S
                                    //Note: the set's format is "name + address"
                                    if (unfoundAddresses.contains(createAddressText(temp.getEntry()))) {
    ...
    private class IndividualReplacementTask
        ...
        protected Void doInBackground(ArrayList<DrawableRecipientChip>... params) {
            ...
            final BaseRecipientAdapter adapter = getAdapter();
            //TS: jin.dong 2015-7-20 EMAIL BUGFIX_1047817 ADD_S
            if (adapter == null) {
                return null;
            }
            //TS: jin.dong 2015-7-20 EMAIL BUGFIX_1047817 ADD_E
            adapter.getMatchingRecipients(addresses, new RecipientMatchCallback() {
    ...
    //TS: jian.xu 2016-01-31 EMAIL BUGFIX-1527821 ADD-S
    /** Check the entry whether has same display name and destination */
    public boolean alreadyHasRecipientEntry(final RecipientEntry entry) {
        final DrawableRecipientChip[] recipients = getText()
                .getSpans(0, getText().length(), DrawableRecipientChip.class);

        for (final DrawableRecipientChip recipient : recipients) {
            final RecipientEntry existingEntry = recipient.getEntry();
            if (existingEntry != null && existingEntry.isSameRecipient(entry)) {
                return true;
            }
        }
        return false;
