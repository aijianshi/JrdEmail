 ...
 *============== ============ =============== ==============================
 *CONFLICT-50006 2014/10/24   zhaotianyong	  Add the package conflict
...
public class Rfc822Validator implements AutoCompleteTextView.Validator {
    ...
    //TS: junwei-xu 2016-01-29 EMAIL BUGFIX-1503251 ADD_S
    /** Check the token's address whether is valid */
    public static boolean isAddressValid(CharSequence text) {
    ...
    /** Check the token's name whether is valid */
    ...
    /** Check the token's name whether is valid, if invalid, fix it. */
    public static String fixInvalidName(String text) {
        if (!TextUtils.isEmpty(text) && !isNameValid(text)) {
            text = text.replaceAll("\"", "");
        }
        return text;
    }
    //TS: rong-tang 2016-03-28 EMAIL BUGFIX-1863457 ADD_E
    //TS: junwei-xu 2016-01-29 EMAIL BUGFIX-1503251 ADD_E
