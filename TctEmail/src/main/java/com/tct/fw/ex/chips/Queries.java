...
/* package */ class Queries {
    ...
    public static final Query EMAIL_INNER_DB = new Query(new String[] {
            EmailContent.RecipientColumns.ID,
            EmailContent.RecipientColumns.EMAIL_ADDRESS,
            EmailContent.RecipientColumns.DISPLAY_NAME,
        }, EmailContent.Recipient.CONTENT_FILTER_URI, EmailContent.Recipient.CONTENT_URI) {
        @Override
        public CharSequence getTypeLabel(Resources res, int type, CharSequence label) {
            return null;
        }
