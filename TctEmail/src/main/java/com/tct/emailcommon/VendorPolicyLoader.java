 ...
 *BUGFIX-1043349 2015/12/04   junwei-xu       [Android 6.0][Email][Monkey][Crash][Monitor]com.tct.email crashs by Short Msg:java.lang.ArrayIndexOutOfBoundsException
 ===========================================================================
 */
 ...
 *
 * <p>Email vendor policy is a system apk named "com.tct.email.helper".  When exists, it must
 * contain a class called "com.tct.email.policy.EmailPolicy" with a static public method
...
public class VendorPolicyLoader {
    private static final String POLICY_PACKAGE = "com.tct.email.policy";
    ...
    public static class Provider implements Serializable {
        ...
        //ke.ma 2015-03-23 EMAIL BUGFIX-951620 ADD_S
        public String display;
        //ke.ma 2015-03-23 EMAIL BUGFIX-951620 ADD_E
        ...
        private String expandTemplate(String template, String email, String user) {
            ...
            //TS: junwei-xu 2015-12-04 EMAIL BUGFIX-1043349 MOD_S
            try {
                ...
                LogUtils.e(LogUtils.TAG, "happen exception when expand template in provider.");
            }
            //TS: junwei-xu 2015-12-04 EMAIL BUGFIX-1043349 MOD_E
            return returnString;
        }
    }
