...
public final class Policy extends EmailContent implements EmailContent.PolicyColumns, Parcelable {
    ...
    public boolean mDisallowSimpleDevicePassword;
    public static final int CONTENT_DISALLOW_SIMPLE_DEVICE_PASSWORD = 23;
    ...
    public boolean equals(Object other) {
        ...
        // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_S
        if (mDisallowSimpleDevicePassword != otherPolicy.mDisallowSimpleDevicePassword) {
            return false;
        }
        // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_E
        return true;
    ...
    public void restore(Cursor cursor) {
        ...
        // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_S
        mDisallowSimpleDevicePassword = cursor.getInt(CONTENT_DISALLOW_SIMPLE_DEVICE_PASSWORD) == 1;
        // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_E
    }
    ...
    public ContentValues toContentValues() {
        ...
        // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_S
        values.put(PolicyColumns.DISALLOW_SIMPLE_DEVICE_PASSWORD, mDisallowSimpleDevicePassword);
        // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_E
        return values;
    }
    ...
    public String toString() {
        ...
        if (equals(NO_POLICY)) {
            ...
            // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_S
            if (mDisallowSimpleDevicePassword) {
                sb.append("nosimplepwd");
            }
            // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_E
            sb.append("]");
        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_S
        dest.writeInt(mDisallowSimpleDevicePassword ? 1 : 0);
        // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_E
    }
    ...
    public Policy(Parcel in) {
        ...
        // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_S
        mDisallowSimpleDevicePassword = in.readInt() == 1;
        // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_E
    }
}