...
import com.tct.emailcommon.utility.SSLUtils;
...
//    public static final String GMAIL_SMTP_SERVER = "smtp.gmail.com";
    ...
    //TS: zheng.zou 2016-3-28 EMAIL BUGFIX_1863562 ADD_S
    /**
     * judge if HostAuth is created by default values;
     * @return true if HostAuth is created by default value, false if HostAuth is created
     * using saved database data
     */
    public boolean isDefaultHostAuth() {
        return mCredentialKey == -1 && mPort == PORT_UNKNOWN;
    }
    //TS: zheng.zou 2016-3-28 EMAIL BUGFIX_1863562 ADD_E
    ...
    public void setConnection(String protocol, String address,
        ...
        if (mPort == PORT_UNKNOWN) {
            ...
            //TS: chaozhang 2015-03-13 EMAIL BUGFIX_944442 ADD_S
            boolean useTLS = ((mFlags & FLAG_TLS) != 0);
            //TS: chaozhang 2015-03-13 EMAIL BUGFIX_944442 ADD_E
            if (LEGACY_SCHEME_SMTP.equals(mProtocol)) {
                ...
                mPort = useSSL ? 465 : 25;
                //TS: wenggangjin 2014-11-21 EMAIL BUGFIX_849813 MOD_S
                //TS: zhaotianyong 2015-04-28 EMAIL BUGFIX_985543 MOD_S
                //TS: chaozhang 2015-03-13 EMAIL BUGFIX_944442 ADD_S
                //NOTE:For gmail smtp server,must use tls +587,can login success
                if ( useTLS) {
                    mPort = 587;
                }
                //TS: chaozhang 2015-03-13 EMAIL BUGFIX_944442 ADD_E
                //TS: zhaotianyong 2015-04-28 EMAIL BUGFIX_985543 MOD_E
            }
        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(mIsUseproxy ? 1 : 0);
        dest.writeString(mProxyAddr);
        dest.writeInt(mProxyPort);
        dest.writeString(mProxyUsername);
        dest.writeString(mProxyUserpass);
    ...
    public HostAuth(Parcel in) {
        ...
        //[FEATURE]-Add-BEGIN by TSNJ.qinglian.zhang,10/28/2014,FR 736417
        mIsUseproxy = in.readInt() == 1 ? true : false;
        mProxyAddr = in.readString();
        mProxyPort = in.readInt();
        mProxyUsername = in.readString();
        mProxyUserpass = in.readString();
        //[FEATURE]-Add-END by TSNJ.qinglian.zhang
    }
