 ...
 */
/**
 * TCT: A html string highlight builder, which use string and query string as input, and build highlighted
 * char sequences.
 */
    ...
    protected boolean init() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (inTag) {
                ...
                char entityCharArr[] = TextUtilities.stripHtmlEntity(mStrToHighlight, i, skipCount);
