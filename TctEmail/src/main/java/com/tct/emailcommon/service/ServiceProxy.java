 ...
 *============== ============ =============== ==============================
 *BUGFIX-904328  2015/1/21     junwei-xu      [Email]Exchange account login fails
 *BUGFIX-906222  2015-01-26   wenggangjin     EmailBroadcastProcessorService
 *===========================================================================
 */
...
import com.tct.emailcommon.utility.AsyncTask; //MODIFIED by zheng.zou, 2016-04-15,BUG-1942054
...
public abstract class ServiceProxy {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    ...
                    } catch (NullPointerException e){//TS: junwei-xu 2015-1-21 EMAIL BUGFIX_904328 ADD
                    } finally {//PR918989-lijuan.li@tcl.com
                        /** tct: Make sure to unbind service connection eventually. @{ */
                        try {
            ...
            //[FEATURE]-Add-BEGIN by CDTS.zhonghua.tuo,08/12/2014,FR 715016
    ...
    protected boolean setTask(ProxyTask task, String name) throws IllegalStateException {
      ...
      //TS: wenggangjin 2015-01-26 EMAIL BUGFIX_906222 MOD_S
//        return mContext.bindService(mIntent, mConnection, Context.BIND_AUTO_CREATE);
      ...
      //TS: wenggangjin 2015-01-26 EMAIL BUGFIX_906222 MOD_E
    }
