...
public class MimeBoundaryInputStream extends InputStream {
    ...
    private boolean matchBoundary() throws IOException {
        ...
        do {
            ...
            //TS: xujian 2015-05-28 EMAIL BUGFIX_995889 ADD_S
            //It's not good to add this code.
            //s.read() return -1 when child match the end boundary and parent will match parent boundary when call s.read().
            //in this condition, parent is not eof.
            if (!moreParts) {
                break;
            }
            // TS: xujian 2015-05-28 EMAIL BUGFIX_995889 ADD_E
            prev = curr;
        } while ((curr = s.read()) != -1);
