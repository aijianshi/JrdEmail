...
import com.tct.email.service.EmailBroadcastProcessorService;
...
public class SecurityPolicy {
    ...
    Policy computeAggregatePolicy() {
        ...
        aggregate.mDisallowSimpleDevicePassword = false;
        ...
        try {
            while (c.moveToNext()) {
                ...
                // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_S
                aggregate.mDisallowSimpleDevicePassword |= policy.mDisallowSimpleDevicePassword;
                // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_E
                policiesFound = true;
            }
        } finally {
    ...
    public int getInactiveReasons(Policy policy) {
        ...
        if (isActiveAdmin()) {
            ...
            // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_S
            if (policy.mDisallowSimpleDevicePassword
                    && !getSimplePasswordDisabled(mAdminName)) {
                if (!dpm.isActivePasswordSufficient()) {
                    reasons |= INACTIVE_NEED_PASSWORD;
                }
            }
    ...
    public void setActivePolicies() {
        ...
        if (aggregatePolicy == Policy.NO_POLICY) {
            ...
            try {
                ...
                if (aggregatePolicy.mPasswordMode > 0 || aggregatePolicy.mDontAllowCamera == true) {
                    //disable
                    dpm.setKeyguardDisabledFeatures(mAdminName, DevicePolicyManager.KEYGUARD_DISABLE_TRUST_AGENTS);
                } else {
                    //enable
                    dpm.setKeyguardDisabledFeatures(mAdminName, dpm.getKeyguardDisabledFeatures(mAdminName) & ~DevicePolicyManager.KEYGUARD_DISABLE_TRUST_AGENTS);
                }
            } catch (SecurityException e) {
                LogUtils.w(Logging.LOG_TAG, e, "happen exception during set active policy in EmailBr oadcastProcessorService#onHandleIntent");
            }
            // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_S
            setSimplePasswordDisabled(mAdminName, aggregatePolicy.mDisallowSimpleDevicePassword);
//            dpm.setSimplePasswordDisabled(mAdminName, aggregatePolicy.mDisallowSimpleDevicePassword);
            // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_E
        }
    }
    ...
    public void setAccountPolicy(long accountId, Policy policy, String securityKey,
        ...
        if (!policyChanged && (TextUtilities.stringOrNullEquals(securityKey,
            ...
            final AccountPreferences accountPreferences =
                    new AccountPreferences(mContext, account.getEmailAddress());
            if (policy!=null && policy.mRequireManualSyncWhenRoaming) {
                accountPreferences.setManualSyncWhenRoamingEnabled(true);
            } else {
                accountPreferences.setManualSyncWhenRoamingEnabled(false);
            }
    ...
    // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_S
    /*
     * Reflect,invoke the method setSimplePasswordDisabled, which is not normal API method
     */
    private void setSimplePasswordDisabled(ComponentName cName, boolean disabled) {
        try {
            Class cls = DevicePolicyManager.class;

            //create method return the DevicePolicyManager object
            Class[] paraTypes = new Class[]{Context.class, Handler.class};
            Context context = mContext;
            Handler handler = new Handler(Looper.getMainLooper());
            Object[] paramsCon = new Object[]{context, handler};
            Method med = cls.getMethod("create", paraTypes);
            //obj is our DevicePolicyManager object
            Object obj = med.invoke(cls, paramsCon);

            Class[] params = new Class[]{ComponentName.class, boolean.class};
            //med1 is our setSimplePasswordDisabled method
            Method med1 = cls.getMethod("setSimplePasswordDisabled", params);
            med1.invoke(obj, cName, disabled);
            LogUtils.i(TAG,"Reflect the method setSimplePasswordDisabled success!disabled : " + disabled);
        } catch (IllegalAccessException e) {
            LogUtils.e(TAG, "setSimplePasswordDisabled! IllegalAccessException while instance the class ");
        } catch (NoSuchMethodException e) {
            LogUtils.e(TAG, "setSimplePasswordDisabled! NoSuchMethodException while get method");
        } catch (InvocationTargetException e) {
            LogUtils.e(TAG, "setSimplePasswordDisabled! InvocationTargetException while invoke the method");
        } catch (IllegalArgumentException e) {
            LogUtils.e(TAG, "setSimplePasswordDisabled! IllegalArgumentException while invoke the method");
        } catch (NullPointerException e) {
            LogUtils.e(TAG, "setSimplePasswordDisabled! NullPointerException while invoke the method");
        }
    }

    /*
     * Reflect,invoke the method getSimplePasswordDisabled, which is not normal API method
     */
    private boolean getSimplePasswordDisabled(ComponentName cName) {
        try {
            Class cls = DevicePolicyManager.class;
            ...
            Class[] params = new Class[]{ComponentName.class};
            //med1 is our getSimplePasswordDisabled method
            Method med1 = cls.getMethod("getSimplePasswordDisabled", params);
            Object result = med1.invoke(obj, cName);
            boolean b = (boolean) result;
            LogUtils.i(TAG,"Reflect the method getSimplePasswordDisabled success! return " + b);
            return b;
        } catch (IllegalAccessException e) {
            LogUtils.e(TAG, "getSimplePasswordDisabled! IllegalAccessException while instance the class ");
        } catch (NoSuchMethodException e) {
            LogUtils.e(TAG, "getSimplePasswordDisabled! NoSuchMethodException while get method");
        } catch (InvocationTargetException e) {
            LogUtils.e(TAG, "getSimplePasswordDisabled! InvocationTargetException while invoke the method");
        } catch (IllegalArgumentException e) {
            LogUtils.e(TAG, "getSimplePasswordDisabled! IllegalArgumentException while invoke the method");
        } catch (NullPointerException e) {
            LogUtils.e(TAG, "getSimplePasswordDisabled! NullPointerException while invoke the method");
        }
        return true;
    }
    // TS: tao.gan 2015-09-22 EMAIL BUGFIX-1068066 ADD_E
