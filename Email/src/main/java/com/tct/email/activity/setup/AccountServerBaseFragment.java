...
public abstract class AccountServerBaseFragment extends AccountSetupFragment
    ...
    public void enableNextButton(boolean enable) {
        ...
        if (mProceedButton != null) {
            ...
            final float proceedButtonAlpha;
            if (enable) {
                proceedButtonAlpha = getResources().getFraction(R.fraction.manual_setup_enabled_alpha, 1, 1);
            } else {
                proceedButtonAlpha = getResources().getFraction(R.fraction.manual_setup_disabled_alpha, 1, 1);
            }
            mProceedButton.setAlpha(proceedButtonAlpha);
