...
import com.tct.email.mail.internet.OAuthAuthenticator;
import com.tct.email.mail.internet.OAuthAuthenticator.AuthenticationResult;
...
public class OAuthAuthenticationActivity extends Activity implements
    ...
    public void onLoadFinished(Loader<AuthenticationResult> loader,
        ...
        if (data == null) {
			...
			Utility.showShortToast(this, R.string.oauth_error_description);
