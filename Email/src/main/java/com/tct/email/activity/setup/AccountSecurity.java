...
public class AccountSecurity extends Activity {
    ...
    public static class SecurityNeededDialog extends DialogFragment
        ...
        private boolean mNeedShowNotification = true;  // TS: jin.dong 2015-2-2 EMAIL BUGFIX_1133931 ADD
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            switch (which) {
                case DialogInterface.BUTTON_POSITIVE:
                    ...
                    mNeedShowNotification = false;      // TS: jin.dong 2015-2-2 EMAIL BUGFIX_1133931 ADD
                    break;
        ...
        // TS: jin.dong 2015-2-2 EMAIL BUGFIX_1133931 ADD_S
        @Override
        public void onDestroy() {
            super.onDestroy();
            if (mNeedShowNotification){
                showNotification();
            }
        }
        ...
        private void showNotification(){
            ...
            if (ac == null)
                return;
            AccountSecurity activity = (AccountSecurity) ac;
            if (activity.mAccount == null) {
                // Clicked before activity fully restored - probably just monkey - exit quickly
                activity.finish();
                return;
        ...
        // TS: jin.dong 2015-2-2 EMAIL BUGFIX_1133931 ADD_E
    }
