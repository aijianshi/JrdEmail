 ...
 *============== ============ =============== ==============================
 *BUGFIX-1040634 2015/07/21   junwei-xu       [GAPP][Email]Not Pop-up Input Method when tap edit quick responses
 *BUGFIX_1126529 2015/12/29   yanhua.chen     [Email]Edit box and notification bar appear overlap after paste more characters
 ===========================================================================
 */
...
public class EditQuickResponseDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mDialog = b.create();
        //TS: yanhua.chen 2015-12-29 EMAIL BUGFIX_1126529 ADD_S
        mDialog.getWindow().getAttributes().gravity = -1;
        //TS: yanhua.chen 2015-12-29 EMAIL BUGFIX_1126529 ADD_E
        //TS: junwei-xu 2015-07-21 EMAIL BUGFIX-1040634 ADD_S
        mDialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_VISIBLE);
        //TS: junwei-xu 2015-07-21 EMAIL BUGFIX-1040634 ADD_E
        return mDialog;
    }
