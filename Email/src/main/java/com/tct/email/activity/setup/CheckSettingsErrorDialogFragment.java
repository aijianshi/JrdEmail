...
*============== ============ =============== =======================================================================
*BUGFIX-933298  2015-02-28   wenggangjin     [Email][Monitor]Log in hotmail account abnormal
====================================================================================================================
*/
    ...
    public static String getErrorString(Context context, MessagingException ex) {
        ...
        switch (ex.getExceptionType()) {
            ...
            case MessagingException.CERTIFICATE_VALIDATION_ERROR:
                //[BUGFIX]-Add-BEGIN by TCTNJ,chuang.wang,10/28/2014,PR-748243
                id = R.string.account_setup_failed_dlg_certificate_message;
                //[BUGFIX]-Add-BEGIN by TCTNJ,chuang.wang
                break;
            case MessagingException.AUTHENTICATION_FAILED:
            ...
            case MessagingException.IOERROR:
              //TS: wenggangjin 2015-03-03 EMAIL BUGFIX_-933298 MOD_S
//                id = R.string.account_setup_failed_security;//[BUGFIX]-Mod by TCTNJ,Zhenhua.Fan,24/11/2014,PR-748243
                id = R.string.account_setup_failed_ioerror;
              //TS: wenggangjin 2015-03-03 EMAIL BUGFIX_-933298 MOD_E
                break;
