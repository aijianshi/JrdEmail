 ...
 *Task_1190494   2015/12/18   jian.xu        Shortest Allowed Polling Interval
 ===========================================================================
 */
...
//                    }
    ...
    public static class EmailServiceInfo {
        ...
        public String defaultSyncInterval;
        ...
        try {
            if (c.moveToNext()) {
                ...
                try {
                    ...
                    moveCalendarData(context, context.getContentResolver(), amName, oldType, accountType);
                    moveContactsData(context, context.getContentResolver(), amName, oldType, accountType);
    ...
    private static void moveCalendarData(Context context, final ContentResolver resolver, final String name,
            final String oldType, final String newType) {
        //TS: zheng.zou 2015-11-27 EMAIL TASK_869664 ADD_S
        if (!PermissionUtil.checkPermissionAndDoNoting(context, Manifest.permission.WRITE_CALENDAR)){    //TS: jin.dong 2015-12-17 EMAIL BUGFIX_1163092 MOD
            LogUtils.i(PermissionUtil.TAG,"permission %s needed in moveCalendarData()", Manifest.permission.WRITE_CALENDAR);
            return;
        }
    ...
    private static void moveContactsData(Context context, final ContentResolver resolver, final String name,
            final String oldType, final String newType) {
        //TS: zheng.zou 2015-11-27 EMAIL TASK_869664 ADD_S
        if (!PermissionUtil.checkPermissionAndDoNoting(context, Manifest.permission.WRITE_CONTACTS)){   //TS: jin.dong 2015-12-17 EMAIL BUGFIX_1163092 MOD
            LogUtils.i(PermissionUtil.TAG,"permission %s needed in moveContactsData()", Manifest.permission.WRITE_CONTACTS);
            return;
        }
        //TS: zheng.zou 2015-11-27 EMAIL TASK_869664 ADD_E
    ...
    private static Map<String, EmailServiceInfo> getServiceMap(final Context context) {
        synchronized (sServiceMapLock) {
            ...
            try {
                ...
                //TS: jian.xu 2015-12-18 EMAIL Task_1190494 MOD_S
                boolean deleteFiveOrTenMinutesOn = PLFUtils.getBoolean(context, "feature_email_deleteFiveOrTenMinutes_on");
                final XmlResourceParser xml;
                if(deleteFiveOrTenMinutesOn){
                    xml = res.getXml(R.xml.att_services);
                } else {
                    xml = res.getXml(R.xml.services);
                }
                //TS: jian.xu 2015-12-18 EMAIL Task_1190494 MOD_E
                int xmlEventType;
                ...
                while ((xmlEventType = xml.next()) != XmlResourceParser.END_DOCUMENT) {
                    if (xmlEventType == XmlResourceParser.START_TAG &&
                        ...
                        info.defaultSyncInterval =
                            ta.getString(R.styleable.EmailServiceInfo_defaultSyncInterval);
