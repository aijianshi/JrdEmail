...
import com.tct.email.EmailApplication;//[BUGFIX]-Add-BEGIN by TCTNJ.zhichuan.wei,03/30/2015,PR 942108
...
//                if (PermissionUtil.checkPermissionAndDoNoting(context, Manifest.permission.READ_PHONE_STATE)) {
//                    TelephonyManager tm =
//                            (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
//                    networkOperator = tm.getNetworkOperatorName();
//                } else {
//                    LogUtils.i(PermissionUtil.TAG,"permission %s needed in getImapId()",Manifest.permission.READ_PHONE_STATE);
//                }
                //TS: jin.dong 2015-12-17 EMAIL BUGFIX_1163092 MOD_E
                //TS: zheng.zou 2015-11-25 EMAIL TASK_996919 MOD_E
                String networkOperator = Device.getNetworkOperatorName(context);
    ...
    private ImapFolder addMailbox(Context context, long accountId, String mailboxPath,
        ...
        updateMailbox(mailbox, accountId, mailboxPath, delimiter, selectable,
                    LegacyConversions.inferMailboxTypeFromName(context, mailboxPath), context);
        ...
        try {
            ...
            for (ImapResponse response : responses) {
                ...
                if (response.isDataResponse(0, ImapConstants.LIST)) {
                    ...
                    if(EmailApplication.isSfrImapFeatureOn() && Account.isSfrImapAccount(mContext, mAccount.mId) && folderName.equals("Sent")){
