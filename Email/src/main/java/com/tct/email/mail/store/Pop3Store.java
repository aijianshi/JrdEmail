...
import com.tct.emailcommon.utility.LoggingInputStream;
...
public class Pop3Store extends Store {
    ...
    public Bundle checkSettings() throws MessagingException {
        ...
        try {
            ...
            if (mAccount != null && mAccount.mEmailAddress != null &&
                    mAccount.mEmailAddress.contains("@") &&
                    "qq.com".equalsIgnoreCase(mAccount.mEmailAddress.split("@")[1])) {
            ...
            //TS: zheng.zou 2016-03-28 EMAIL BUGFIX-1863890 ADD_S
            //note: the exception flow should propagate for later process, not end here.
            throw me;
            //TS: zheng.zou 2016-03-28 EMAIL BUGFIX-1863890 ADD_E
        } finally {
