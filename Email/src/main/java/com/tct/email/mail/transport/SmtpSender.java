 ...
 *BUGFIX-1749199 2016/03/11   rong-tang       [Email]Pop up"Username or password is incorrect" when log in account with right username and password
 *BUGFIX-1863189 2016/03/31   tianjing.su     [jrdlogger]com.tct.email Native (NE)
 ===========================================================================
 */

package com.tct.email.mail.transport;
...
public class SmtpSender extends Sender {
    ...
    public void sendMessage(long messageId) throws MessagingException {
        ...
        try {
            ...
            long spendTime = afterTime - beforeTime;
             /*MODIFIED-BEGIN by tianjing.su, 2016-03-31,BUG-1863189*/
            Log.i("Email", "Sending message spend" + spendTime);
        } catch (IOException ioe) {
            throw new MessagingException("Unable to send message", ioe);
        }
        //[BUGFIX]-Add-BEGIN by TSCD.tianjing.su,03/31/2016,1863189
        //NOTE:After send message,close all connection to release FD
        finally {
            close();
            Log.i("Email","After send message,close all connection");
        }
        //[BUGFIX]-Add-BEGIN by TSCD.tianjing.su,03/31/2016,1863189,
         /*MODIFIED-END by tianjing.su,BUG-1863189*/
    }
    ...
    private String executeSensitiveCommand(String command, String sensitiveReplacement)
        ...
        //[BUGFIX]-Add-BEGIN by TSNJ shaodong.wang,10/30/2014,FR-736448.
        if (line == null) {
            line = "";
        }
...
//    S: 235 2.0.0 OK Authenticated
    ...
    private void saslAuthPlain(String username, String password) throws MessagingException,
        ...
        try {
            ...
            if (me.getMessage().length() > 1 && me.getMessage().charAt(1) == '3') {
                //TS: rong-tang 2016-03-11 EMAIL BUGFIX-1749199 ADD_S
                //Note: For qq account, we should use the error message from mail server.
                if (username != null && username.contains("@") &&
                        "qq.com".equalsIgnoreCase(username.split("@")[1])) {
                    throw new AuthenticationFailedException(MessagingException.UNSPECIFIED_EXCEPTION, me.getMessage());
                }
                //TS: rong-tang 2016-03-11 EMAIL BUGFIX-1749199 ADD_E
                throw new AuthenticationFailedException(me.getMessage());
            }
            throw me;
        }
