...
/* ----------|----------------------|----------------------|----------------- */
/* 04/02/2014|fu.zhang              |622697                |[HOMO][HOMO][Oran */
/*           |                      |                      |ge][Homologation] */
/*           |                      |                      | Exchange Active  */
/*           |                      |                      |Sync Priority     */
/* ----------|----------------------|----------------------|----------------- */
...
public final class ImapConstants {
    ...
    //[FEATURE]-Add-BEGIN by TCTNB.fu.zhang,04/02/2014,622697,
    //exchange active sync priority feature
    public static final String FETCH_FIELD_HEADERS =
            "BODY.PEEK[HEADER.FIELDS (date subject from content-type to cc message-id Importance Priority X-Priority)]";
