...
/**
 *  TCT: Suggestions provider for Email. Queries the "words" table to provide possible word suggestions.
 */
public class EmailSuggestionsProvider extends android.content.ContentProvider {
    ...
    private static final String AUTHORITY = "com.tct.email.provider.EmailSuggestionsProvider";
    ...
    public static final String ACTION_SEARCH_SUGGESTION_CLICKED =
            "com.android.email.action.SEARCH_SUGGESTION_CLICKED";
