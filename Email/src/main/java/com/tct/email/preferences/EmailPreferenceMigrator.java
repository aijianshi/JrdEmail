 ...
 */
package com.tct.email.preferences;
        ...
        if (oldVersion < 1) {
            ...
            for (final Account account : accounts) {
                ...
                final Cursor ecAccountCursor = context.getContentResolver().query(
                        com.tct.emailcommon.provider.Account.CONTENT_URI,
                        com.tct.emailcommon.provider.Account.CONTENT_PROJECTION,
                        AccountColumns.EMAIL_ADDRESS + " = ?",
                        new String[] { account.getEmailAddress() },
                        null);
                final com.tct.emailcommon.provider.Account ecAccount =
                        new com.tct.emailcommon.provider.Account();
                ...
                final boolean notify = (ecAccount.getFlags()
                        & com.tct.emailcommon.provider.Account.FLAGS_NOTIFY_NEW_MAIL) != 0;
                ...
                final boolean vibrate = (ecAccount.getFlags()
                        & com.tct.emailcommon.provider.Account.FLAGS_VIBRATE) != 0;
