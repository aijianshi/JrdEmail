 ...
 *BUGFIX-893188  2015/01/07   xiaolin.li      [Android5.0][Email][Monkey][Crash] com.tct.email crash at java.lang.IllegalArgumentException: Log tag 'FragmentStatePagerAdapter' exceeds limit of 23 characters
 *BUGFIX-1106488 2015/11/02   jian.xu         [Android L][Email][Monkey][Crash] java.lang.NullPointerException: Attempt to invoke virtual method 'void android.app.Fragment.setMenuVisibility
 ===========================================================================================================
 */
...
public abstract class FragmentStatePagerAdapter2 extends PagerAdapter {
	// TS: xiaolin.li 2015-01-07 EMAIL BUGFIX-893188 MOD_S
    //private static final String TAG = "FragmentStatePagerAdapter";
	private static final String TAG = "StatePagerAdapter";
    // TS: xiaolin.li 2015-01-07 EMAIL BUGFIX-893188 MOD_E
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        //TS: jian.xu 2015-11-02 EMAIL BUGFIX-1106488 MOD_S
        if (fragment != null && fragment != mCurrentPrimaryItem) {
            setItemVisible(fragment, false);
        }
        //TS: jian.xu 2015-11-02 EMAIL BUGFIX-1106488 MOD_E
    ...
    public void finishUpdate(ViewGroup container) {
        if (mCurTransaction != null) {
            ...
            try{
               ...
               LogUtils.w(TAG, "FragmentStatePagerAdapter2-->finishUpdate Exception");
            }
