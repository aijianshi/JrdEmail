...
import com.tct.mail.perf.SimpleTimer;
...
import com.tct.mail.ui.HelpActivity;
...
public class Utils {
    ...
    public static final String ACTION_NOTIFY_DATASET_CHANGED =
            "com.tct.mail.ACTION_NOTIFY_DATASET_CHANGED";
    ...
    public static final String EXCHANGE_ACCOUNT_MANAGER_TYPE = "com.tct.exchange";
    public static final int TYPE_IMAP = 1;
    public static final int TYPE_POP3 = 2;
    public static final int TYPE_EAS = 3;
    // TS: gangjin.weng 2015-04-20 EMAIL BUGFIX_940964 ADD_E

  //TS: tao.gan 2015-09-11 EMAIL FEATURE-559893 ADD_S
    //Only exceeds the vertical offset then we do the action:show or hide action bar.
    public static int OFFSET_DO_ACTION = 5;
  //TS: tao.gan 2015-09-11 EMAIL FEATURE-559893 ADD_E
    ...
    public static boolean isRunningLOrLater() {
        ...
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP;  //Enable third-party cookies. b/16014255
    }
    ...
    private static final CharacterStyle ACTION_BAR_UNREAD_STYLE = new StyleSpan(Typeface.NORMAL);//TS: junwei-xu 2015-3-13 EMAIL BUGFIX_925761 MOD
   ...
   public static int getTransparentColor(int color) {
    ...
    /** TCT: set the availability and visibility, cause the visibility could not prevent action in s
     ome case,
     * such as trigger alphabetic shortcut by key event.
     * @param menu
     * @param itemId
     * @param enable
     */
    public static void setMenuItemVisibilityAndAvailability(Menu menu, int itemId, boolean enable) {
        final MenuItem item = menu.findItem(itemId);
        if (item == null) {
            return;
        }
    ...
    /**
     * For user want to custom the hint text for Edit text, Such as set the size of hint..
     * @param editText The EditText which want to setHint
     * @param string  The hint string
     * @param hintSize The hint size want to set
     * @return
     */
    public static void setEditTextHint(EditText editText, String string, int hintSize){
