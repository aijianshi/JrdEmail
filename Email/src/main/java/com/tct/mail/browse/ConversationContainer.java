 ...
 *BUGFIX-926524  2015-02-06   wenggangjin     [Email] Merge Qualcomm patch to solve crash issue
 ============================================================================
 */
...
import com.tct.mail.utils.DequeMap;
import com.tct.mail.utils.InputSmoother;
    ...
    private void positionAdditionalBottomBorder(boolean postAddView) {
        ...
        if (speculativeHeight > 0) {
            ...
            if (mAdditionalBottomBorder != null && mAdditionalBottomBorderAdded) {
              //TS: wenggangjin 2015-02-03 EMAIL BUGFIX_-926524 MOD_S
//                removeViewInLayout(mAdditionalBottomBorder);
                if (postAddView) {
              ...
              //TS: wenggangjin 2015-02-03 EMAIL BUGFIX_-926524 MOD_E
                mAdditionalBottomBorderAdded = false;
            }
        }
    }
  //TS: wenggangjin 2015-02-03 EMAIL BUGFIX_-926524 ADD_S
  ...
  //TS: wenggangjin 2015-02-03 EMAIL BUGFIX_-926524 ADD_E
