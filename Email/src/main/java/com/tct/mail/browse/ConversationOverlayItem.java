...
import com.tct.mail.browse.ConversationViewAdapter.ConversationViewType;
...
public abstract class ConversationOverlayItem {
     ...
     * {@link com.tct.mail.browse.ConversationViewAdapter.BorderItem}
     * to update the height of the border based on whether the neighboring messages
     * are collapsed or expanded.<br><br>
     *
     * It is also used by {@link com.tct.mail.browse.ConversationViewAdapter.MessageHeaderItem}
     ...
     * {@link com.tct.mail.browse.ConversationViewAdapter#notifyDataSetChanged()}
