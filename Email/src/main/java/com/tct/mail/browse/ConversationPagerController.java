...
import com.tct.mail.graphics.PageMarginDrawable;
...
import com.tct.mail.ui.RestrictedActivity;
...
public class ConversationPagerController {
    ...
    public void show(Account account, Folder folder, Conversation initialConversation,
        ...
        //TS: zheng.zou 2016-1-15 EMAIL BUGFIX_1161885 ADD_S
        //this is an ViewPager bug that will load extra child fragment if setAdapter again.
        //reset the mFirstLayout before setAdapter() solved this
        resetViewPagerFirstLayoutValue();
        //TS: zheng.zou 2016-1-15 EMAIL BUGFIX_1161885 ADD_E
        mPager.setAdapter(mPagerAdapter);
        //TS: jian.xu 2015-12-31 EMAIL BUGFIX-1126519 ADD_S
        //Note: For unread folder, we forbidden the action of slide right/left to view email.
        //So, set it as detached mode.
        if (folder != null && folder.isType(UIProvider.FolderType.UNREAD)) {
            mPagerAdapter.setDetachedMode(true);
        }
        //TS: jian.xu 2015-12-31 EMAIL BUGFIX-1126519 ADD_E
    ...
    private void resetViewPagerFirstLayoutValue(){
        try {
            Field firstLayoutField = ViewPager.class.
