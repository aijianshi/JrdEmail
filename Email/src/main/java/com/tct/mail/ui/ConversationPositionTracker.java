 ...
 *============== ============ =============== ==============================
 *BUGFIX_729798  2015/10/20     lin-zhou      [Android L][Email][Monkey][Crash]java.lang.NullPointerException happened during monkey test
 *===========================================================================
 */
...
public class ConversationPositionTracker {
    ...
    private int calculatePosition() {
        ...
        if (!mCursorDirty) {
            //TS: lin-zhou 2015-10-20 EMAIL BUGFIX_729798 MOD_S
            if (mConversation != null) {
                return mConversation.position;
            } else {
                return invalidPosition;
            }
            //TS: lin-zhou 2015-10-20 EMAIL BUGFIX_729798 MOD_E
        }
