 ...
 *============== ============ =============== ==============================
 *BUGFIX-879478  2014/12/23   junwei-xu       [Email]Edit the widget name is empty silent
 *===========================================================================
 */
...
//TS: junwei-xu 2014-12-23 EMAIL BUGFIX_879478 ADD_S
import android.view.Gravity;
//TS: junwei-xu 2014-12-23 EMAIL BUGFIX_879478 ADD_E
...
public class ShortcutNameActivity extends Activity implements OnClickListener,
    ...
    private void doCreateShortcut() {
        ...
        //TS: junwei-xu 2014-12-23 EMAIL BUGFIX_879478 MOD_S
        if(TextUtils.getTrimmedLength(shortcutName)<=0){
            Toast toast = Toast.makeText(this, R.string.empty_no_allowed, Toast.LENGTH_SHORT);
        ...
        //TS: junwei-xu 2014-12-23 EMAIL BUGFIX_879478 MOD_E
    }
