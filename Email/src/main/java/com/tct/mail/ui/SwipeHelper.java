...
public class SwipeHelper {
    ...
    public static final int SWIPE_DIRECTION_TO_RIGHT = 0;
    public static final int SWIPE_DIRECTION_TO_LEFT = 1;
    ...
    //TS: zheng.zou 2015-09-01 EMAIL BUGFIX_526255 ADD_S
    private SwipeableConversationItemView mCurrItemView;
    private View mCurrLeftAnimView;
    private View mCurrRightAnimView;
    //TS: zheng.zou 2015-09-01 EMAIL BUGFIX_526255 ADD_E
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (view instanceof SwipeableConversationItemView) {
                    mCurrItemView = (SwipeableConversationItemView) view;
                    mCurrView =  mCurrItemView.getSwipeableItemView();
                ...
                if (mCurrView != null) {
                    ...
                    //TS: zheng.zou 2015-09-01 EMAIL BUGFIX_526255 ADD_S
                    mCurrLeftAnimView = mCurrItemView.getLeftSideView();
                    mCurrRightAnimView = mCurrItemView.getRightSideView();
                    //TS: zheng.zou 2015-09-01 EMAIL BUGFIX_526255 ADD_E
            ...
            case MotionEvent.ACTION_MOVE:
                if (mCurrView != null) {
                    ...
                    if (Math.abs(delta) > mPagingTouchSlop) {
                        ...
                        mDragging = mCurrItemView!=null && !mCurrItemView.isAnimating(); //TS: zheng.zou 2015-09-01 EMAIL BUGFIX_526255 MOD
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mCurrView != null) {
                    ...
                    //note: do not show aciton icon when disable swipe
                    if (mCallback.canChildBeDismissed(mCurrView)){
                        //TS: zheng.zou 2015-09-01 EMAIL BUGFIX_526255 ADD_S
                        if (deltaX>0){
                            mCurrLeftAnimView.setVisibility(View.VISIBLE);
                            mCurrRightAnimView.setVisibility(View.GONE);
                        }else {
                            mCurrLeftAnimView.setVisibility(View.GONE);
                            mCurrRightAnimView.setVisibility(View.VISIBLE);
                        }
                        //TS: zheng.zou 2015-09-01 EMAIL BUGFIX_526255 ADD_E
                    }else {
                        mCurrLeftAnimView.setVisibility(View.GONE);
            ...
            case MotionEvent.ACTION_CANCEL:
                if (mCurrView != null) {
                    ...
                    int direction = (childSwipedFastEnough && velocity>0)||(childSwipedFarEnough && mCurrAnimView.getTranslationX()>0)
                            ? SWIPE_DIRECTION_TO_RIGHT :SWIPE_DIRECTION_TO_LEFT;    //TS: zheng.zou 2015-09-01 EMAIL BUGFIX_526255 ADD
                    mCallback.setSwipeDirection(direction);
    ...
    public interface Callback {
        ...
        void setSwipeDirection(int direction);  //TS: zheng.zou 2015-09-01 EMAIL BUGFIX_526255 ADD
    }
}
