...
public class ConversationListHelper {
    ...
    public ArrayList<ConversationSpecialItemView> makeConversationListSpecialViews(
        ...
        final ConversationSortTipView sortTipView =
                (ConversationSortTipView) LayoutInflater.from(context)
                        .inflate(R.layout.conversation_sort_tip_view, null);
        ...
        itemViews.add(sortTipView);    //TS: zheng.zou 2016-1-14 EMAIL TASK_1431225 ADD
        return itemViews;
    }
}
