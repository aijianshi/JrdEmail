        ...
        setActionClickListener(new OnClickListener() {
            ...
            public void onClick(View widget) {
                if (op.shouldTakeOnActionClickedPrecedence()) {
                    ...
                    //NOTE: Pass the operation number that AAC#getUndoClickedListener() will use it
                    op.onActionClicked(getContext(),mOperation.getUndoNum());
                } else {
                    listener.onActionClicked(getContext(),mOperation.getUndoNum());
                }
