 ...
 *============== ============ =============== ==============================
 *BUGFIX-964134  2015/04/01   zhichuan.wei    [Force close][Android5.0][Email]Email force close
===========================================================================
 */
...
import com.tct.mail.utils.UIProvider.SyncStatus;
import java.lang.reflect.Field;//[BUGFIX]-Add-BEGIN by TCTNJ.zhichuan.wei,04/01/2015,PR 964134
...
public class WaitFragment extends Fragment implements View.OnClickListener,
    ...
    //[BUGFIX]-Add-BEGIN by TCTNJ.zhichuan.wei,04/01/2015,PR 964134
    @Override
