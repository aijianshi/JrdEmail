 ...
 *BUGFIX-717280  2015/10/14   jian.xu    	  [Android L][Email]The same folder in recent folder and all folder display different unread mail number
...
import com.tct.mail.providers.AllAccountObserver;
...
import com.tct.mail.providers.RecentFolderObserver;
...
public class FolderListFragment extends ListFragment implements
    ...
    private class FolderAdapter extends BaseAdapter implements FolderListFragmentCursorAdapter {
         ...
         * populating {@link com.tct.mail.ui.FolderListFragment.FolderAdapter#mItemList}
         */
        ...
        private List<DrawerItem> recalculateListFolders() {
            ...
            //TS: jian.xu 2015-10-14 EMAIL BUGFIX-717280 ADD_S
            //Note: Update recent folder cache
            if (mRecentFolders != null) {
                mRecentFolders.updateFolderCache(mCursor);
            }
            //TS: jian.xu 2015-10-14 EMAIL BUGFIX-717280 ADD_E
    ...
    /**
     * Check if should show this account's color block.
     * @param account the account be checked.
     */
    public boolean isAccountColorBlockVisible(Account account) {
        boolean isVisible = false;
        if (mCurrentAccount != null && mCurrentAccount.getAccountId().equalsIgnoreCase("Account Id")
                && !account.getAccountId().equalsIgnoreCase("Account Id")) {
            isVisible = true;
        }
        return isVisible;
    }
    ...
    private List<DrawerItem> buildAccountList() {
        ...
        for (final Account account : allAccounts) {
            ...
            accountList.add(DrawerItem.ofAccount(mActivity, account, unreadCount, currentAccountUri.equals(account.uri),
                    isAccountColorBlockVisible(account), mImagesCache, mContactResolver));
    ...
    private class FooterAdapter extends BaseAdapter {
        ...
        //TS: zheng.zou 2015-07-31 EMAIL BUGFIX_-1052918 ADD_S
        @Override
        public boolean isEnabled(int position) {
            //the top and bottom item is un-clickable
            return position > 0 && position < getCount() - 1;
        }
        //TS: zheng.zou 2015-07-31 EMAIL BUGFIX_-1052918 ADD_E
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            footerItemView.findViewById(R.id.drawer_footer_layout).setVisibility(
                    item instanceof EmptyItem ? View.GONE : View.VISIBLE);       //TS: zheng.zou 2015-07-31 EMAIL BUGFIX_-1052918 ADD
        ...
        private void update() {
            ...
            if (mCurrentAccount != null) {
                //add top divider line fake item
                mFooterItems.add(new EmptyItem());  //TS: zheng.zou 2015-07-31 EMAIL BUGFIX_-1052918 ADD
    ...
    //TS: zheng.zou 2015-07-31 EMAIL BUGFIX_-1052918 ADD_S
    private class EmptyItem extends FooterItem {

        protected EmptyItem() {
            //fake empty resources
            super(R.drawable.ic_drawer_settings, R.string.menu_settings);
        }
