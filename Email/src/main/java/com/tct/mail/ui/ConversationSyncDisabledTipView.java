...
*============== ============ =============== ============================================================
*BUGFIX-958947  2015/03/26   gangjin.weng    [Moniotr][Email]FC when add email widget to homescreen
=========================================================================================================
*/
...
public class ConversationSyncDisabledTipView extends FrameLayout
    ...
    public static int calculateReasonSyncOff(MailPrefs mailPrefs,
        ...
        //TS: gangjin.weng 2015-3-26 EMAIL BUGFIX_958947 MOD_S
        ...
        if (!autoSync) {
        //TS: gangjin.weng 2015-3-26 EMAIL BUGFIX_958947 MOD_E
