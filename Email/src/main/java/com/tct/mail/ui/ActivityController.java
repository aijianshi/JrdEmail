...
import com.tct.mail.browse.ConversationCursor.ConversationListener;
 ...
 *     {@link com.tct.mail.ui.ControllableActivity#getAccountController()}. This allows
...
public interface ActivityController extends LayoutListener,
        ...
        RecentFolderController, FragmentLauncher, KeyboardNavigationController, CompoundButton.OnCheckedChangeListener {
    ...
    /**
     * Returns the current star toggle status.
     */
    boolean getCurrentStarToggleStatus();
    ...
    /**
     * request permission callback delegate
     * @param requestCode
     * @param permissions
     * @param grantResults
     */
    ...
    /**
     * Begin a local search with the given query string.
     */
    ...
    /**
     * TCT: Called when user press search menu or switch search field tab.
     */
    void enterLocalSearch(String field);

            /**
             * TCT: Called when user press back key to exit local search mode.
             */
    void exitLocalSearch();


            /**
             * TCT: Called to execute keywords local search.
             */
//    void executeLocalSearch(String query);
  ...
  //TS: tao.gan 2015-10-10 EMAIL FEATURE-559891 ADD_S
    void setSearchHeader(HorizontalScrollView header);
