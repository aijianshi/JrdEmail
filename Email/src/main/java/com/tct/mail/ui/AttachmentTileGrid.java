 ...
 *BUGFIX-872893  2014/12/18   wenggangjin     [Android 5.0][Exchange]There is attachment icon when there is no attachment in the email
 ===========================================================================
 */
...
import com.tct.mail.browse.MessageAttachmentTile;
import com.tct.mail.compose.ComposeAttachmentTile;
import com.tct.mail.photo.MailPhotoViewActivity;
...
import com.tct.mail.ui.AttachmentTile.AttachmentPreviewCache;
...
public class AttachmentTileGrid extends FrameLayout implements AttachmentPreviewCache,
    ...
    public void configureGrid(FragmentManager fragmentManager, Account account,
      ...
      //TS: wenggangjin 2014-12-18 EMAIL BUGFIX_872893 MOD_S
      //TS: wenggangjin 2014-12-10 EMAIL BUGFIX_852100 MOD_S
//        int childCount = getChildCount();
//        if (childCount >= 1) {
//            for (int i = childCount; i > 0; i--) {
//                Attachment att = list.get(i-1);
//                if (att !=null && att.contentId != null && att.contentId.length() > 0) {
//                    removeViewAt(i-1);
//                }
//            }
//        }
      //TS: wenggangjin 2014-12-10 EMAIL BUGFIX_852100 MOD_E
      //TS: wenggangjin 2014-12-18 EMAIL BUGFIX_872893 MOD_E
    }
