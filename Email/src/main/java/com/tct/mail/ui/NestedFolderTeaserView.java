...
import com.tct.fw.google.common.collect.ImmutableSortedSet;
...
//    private TextView mShowMoreFoldersCountTextView;
    ...
    private static class FolderHolder {
        ...
        //TS: junwei-xu 2015-1-12 EMAIL BUGFIX_922163 DEL_S
        //private final TextView mSendersTextView;
        //TS: junwei-xu 2015-1-12 EMAIL BUGFIX_922163 DEL_E
        private final TextView mCountTextView;
        private Folder mFolder;
        private List<String> mUnreadSenders = ImmutableList.of();

        public FolderHolder(final View itemView, final TextView countTextView) {//TS: junwei-xu 2015-1-12 EMAIL BUGFIX_922163 MOD
            mItemView = itemView;
          //TS: junwei-xu 2015-1-12 EMAIL BUGFIX_922163 DEL_S
    ...
    public NestedFolderTeaserView(
        ...
        mTabletDevice = com.tct.mail.utils.Utils.useTabletUI(resources);
...
//            mShowMoreFoldersCountTextView.setVisibility(GONE);
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        if (com.tct.mail.utils.Utils.getDisplayListRightEdgeEffect(mTabletDevice,
