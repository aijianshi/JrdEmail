...
public class ToastBarOperation implements Parcelable,
    ...
    public static final int INFO = 4;   //TS: zheng.zou 2015-11-25 EMAIL TASK_996919 ADD
    ...
    public String getDescription(Context context) {
        ...
        } else if (mAction == R.id.swipe_delete){  //TS: zheng.zou 2015-09-01 EMAIL BUGFIX_526255 ADD_S
            return context.getResources().getString(R.string.deleted);
        } else if (mAction == R.id.swipe_star){
            return context.getResources().getString(R.string.starred);
        } else if (mAction == R.id.swipe_unstar){
            return context.getResources().getString(R.string.unstarred);    //TS: zheng.zou 2015-09-01 EMAIL BUGFIX_526255 ADD_E
    ...
    //NOTE:modify the interface that AAC#getUndoClickedListener() want know the operation numbers.
    @Override
