 ...
 *BUGFIX-1040757  2015/07/10   xujian          [HOMO][Orange Spain] Stability of the handset is not good
 *BUGFIX-1044483  2015/8/11   zheng.zou       [SW][Email]Add the email widget on idle, it display loading always
 *BUGFIX-1453465 2016/01/19   jian.xu         [After Sale][Stability][AndroidReboot]
 *BUGFIX-1939466 2016/04/15   yanhua.chen         [Monkey][ANR][Email]NOT RESPONDING: com.tct.email (pid 21654)
 ===========================================================================
 */
...
import com.tct.emailcommon.utility.AsyncTask; //MODIFIED by Yanhua.chen, 2016-04-15,BUG-1939466
...
import com.tct.mail.ui.MailboxSelectionActivity;
...
//TS: xujian 2015-07-10 EMAIL BUGFIX_1040757 ADD_S
//TS: xujian 2015-07-10 EMAIL BUGFIX_1040757 ADD_E
public abstract class BaseWidgetProvider extends AppWidgetProvider {
    ...
    protected static final String ACTION_UPDATE_WIDGET = "com.tct.mail.ACTION_UPDATE_WIDGET";
    protected static final String
            ACTION_VALIDATE_ALL_WIDGETS = "com.tct.mail.ACTION_VALIDATE_ALL_WIDGETS";
  ...
  //TS: xujian 2015-07-10 EMAIL BUGFIX_1040757 ADD_S
    ...
    //This value is used to avoid too much update widget in 1s.
    private static final long  UPDATE_CACHE_TIME= 1000;
  //This value is used to update widget. The value can be others.
    private static final int  UPDATE_WIDGET_ACTION= 3;
    ...
    private Handler mHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            LogUtils.d("Email", "BulkUpdateAsyncTask");
            new UpdateAsyncTask(mContext).execute((Void[]) null);
        }
    };
    ...
    private class UpdateAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(final Void... params) {
            validateAllWidgetInformation(mContext);
            return null;
        }
  ...
  //TS: xujian 2015-07-10 EMAIL BUGFIX_1040757 ADD_E
    ...
    protected int[] getCurrentWidgetIds(Context context) {
        ...
        //TS: jian.xu 2016-01-19 EMAIL BUGFIX-1453465 MOD_S
        //Note: this operate maybe happened exception, we should catch it.
        try {
            return appWidgetManager.getAppWidgetIds(mailComponent);
        } catch (RuntimeException e) {
            LogUtils.w(LOG_TAG, e, "happened runtime exception while get current widget ids.");
        }
        return new int[0];
        //TS: jian.xu 2016-01-19 EMAIL BUGFIX-1453465 MOD_E
    }
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      //TS: xujian 2015-07-10 EMAIL BUGFIX_1040757 ADD_E
        ...
        if (ACTION_UPDATE_WIDGET.equals(action)) {
          ...
          //TS: xujian 2015-07-10 EMAIL BUGFIX_1040757 MOD_S
        ...
        } else if (ACTION_NOTIFY_MESSAGE_LIST_DATASET_CHANGED.equals(action)) {
            long currentTime = System.currentTimeMillis();
            LogUtils.d("Email", "MESSAGE_LIST_DATASET_CHANGED");
            if(currentTime - mLastTime > UPDATE_CACHE_TIME){
                LogUtils.d("Email", "sendEmptyMessageDelayed");
                mLastTime = currentTime;
                //TS: yanhua 2016-03-3 EMAIL BUGFIX_1716862 ADD_S
                //NOTE:avoid broadcast cause many pending messages.
                mHandler.removeMessages(UPDATE_WIDGET_ACTION);
                //TS: yanhua 2016-03-3 EMAIL BUGFIX_1716862 ADD_E
                mHandler.sendEmptyMessageDelayed(UPDATE_WIDGET_ACTION, UPDATE_CACHE_TIME);
            }
          //TS: xujian 2015-07-10 EMAIL BUGFIX_1040757 MOD_E
    ...
    protected void updateWidgetInternal(Context context, int appWidgetId, Account account,
        ...
        if (!isAccountValid(context, account) || !isFolderValid(context, folderUri)) {
            LogUtils.i(LogTag.getLogTag(),"BaseWidgetProvider updateWidgetInternal invalid accout or folder");     //TS: zheng.zou 2015-08-11 EMAIL BUGFIX_1044483 ADD
            ...
            LogUtils.i(LogTag.getLogTag(),"BaseWidgetProvider updateWidgetInternal");     //TS: zheng.zou 2015-08-11 EMAIL BUGFIX_1044483 ADD
