...
*============== ============ =============== =======================================================================
*BUGFIX-950488  2015-03-16   wenggangjin     [Monkey][Crash]com.tct.email java.lang.IndexOutOfBoundsException
====================================================================================================================
*/
package com.tct.mail.content;
...
public class ThreadSafeCursorWrapper extends CursorWrapper {
    ...
    public long getLong(int column) {
        synchronized (mLock) {
            moveToCurrent();
          //TS: wenggangjin 2015-03-16 EMAIL BUGFIX_-950488 MOD_S
            if(column < 0){
                return 0;
            }
          //TS: wenggangjin 2015-03-16 EMAIL BUGFIX_-950488 MOD_E
