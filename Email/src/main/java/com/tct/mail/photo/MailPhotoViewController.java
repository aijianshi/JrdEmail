...
//import com.tct.ex.photo.ActionBarInterface;
...
import com.tct.fw.ex.photo.ActionBarInterface;
...
import com.tct.mail.browse.AttachmentActionHandler;
    ...
    public void updateActionItems() {
        ...
        if (attachment != null && mSaveItem != null && mShareItem != null) {
            ...
            if (mHideExtraOptionOne) {
                ...
                //[BUGFIX]-ADD BEGIN BY TSNJ shaodong.wang, 11/26/2014, PR-851232.
                mExtraOption1Item.setVisible(false);
