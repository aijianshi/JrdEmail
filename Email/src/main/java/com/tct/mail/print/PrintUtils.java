 ...
 *============== ============ =============== =============================================================
 *BUGFIX-933163  2015/02/28   zhonghua.tuo   [Force Close][Email]Force close when print no content.eml file in Email attachment
 ==========================================================================================================
 */

package com.tct.mail.print;
...
public class PrintUtils {
    ...
    private static void appendSingleMessageHtml(Context context, Resources res,
        ...
        //TS: zhonghua.tuo 2015-02-28 EMAIL BUGFIX_ 933163 MOD_S
        String personal = "";
        String address = "";
        if (fromAddress != null) {
