 ...
 *BUGFIX-989524  2015/4/30    yanhua.chen     [Email] Change the mail size limitation to 10M
...
import com.tct.mail.providers.UIProvider.DefaultReplyBehavior;
import com.tct.mail.providers.UIProvider.SnapHeaderValue;
...
public class Settings implements Parcelable {
    ...
    //TS: yanhua.chen 2015-4-30 EMAIL BUGFIX_989524 MOD_S
    // Max size for attachments (5 megs). Will be overridden by an account
    // setting, if found.
    private static final int DEFAULT_MAX_ATTACHMENT_SIZE = 20 * 1024 * 1024;
    public static final int DEFAULT_MID_ATTACHMENT_SIZE = 10 * 1024 * 1024;
    //TS: yanhua.chen 2015-4-30 EMAIL BUGFIX_989524 MOD_E
    ...
    public final String replyTo;//TS: zheng.zou 2016-03-21 EMAIL BUGFIX_1801683 ADD
    ...
    private Settings() {
        ...
        replyTo = "";//TS: zheng.zou 2016-03-21 EMAIL BUGFIX_1801683 ADD
    }
    ...
    public Settings(Parcel inParcel) {
        ...
        replyTo = inParcel.readString();//TS: zheng.zou 2016-03-21 EMAIL BUGFIX_1801683 ADD
    }
    ...
    public Settings(Cursor cursor) {
        ...
        replyTo = cursor.getString(cursor.getColumnIndex(SettingsColumns.REPLY_TO));//TS: zheng.zou 2016-03-21 EMAIL BUGFIX_1801683 ADD
    }
    ...
    private Settings(JSONObject json) {
        ...
        replyTo = json.optString(SettingsColumns.REPLY_TO,sDefault.replyTo);//TS: zheng.zou 2016-03-21 EMAIL BUGFIX_1801683 ADD
    }
    ...
    public synchronized JSONObject toJSON() {
        ...
        try {
            ...
            json.put(SettingsColumns.REPLY_TO, replyTo);//TS: zheng.zou 2016-03-21 EMAIL BUGFIX_1801683 ADD
    ...
    public Map<String, Object> getValueMap(Map<String, Object> map) {
        ...
        map.put(SettingsColumns.REPLY_TO, replyTo);//TS: zheng.zou 2016-03-21 EMAIL BUGFIX_1801683 ADD
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(replyTo);//TS: zheng.zou 2016-03-21 EMAIL BUGFIX_1801683 ADD
    }
