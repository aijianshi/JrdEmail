 ...
 *CONFLICT-20001 2014/10/24   wenggangjin	Modify the package conflict
 ============================================================================ 
 */
package com.tct.mail.providers.protos.mock;
...
import com.tct.mail.providers.UIProvider.AccountColumns;
...
import com.tct.mail.providers.UIProvider.FolderColumns;
...
public final class MockUiProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.tct.mail.mockprovider";
    ...
    public static Map<String, Object> createAccountDetailsMap(int accountId,String defaultInbox) {
        ...
        accountMap.put(AccountColumns.TYPE, "com.tct.mail.providers.protos.mock");
