...
import com.tct.mail.providers.UIProvider.ConversationCursorCommand;
import com.tct.mail.ui.ConversationCursorLoader;
...
public class Conversation implements Parcelable {
    ...
    // Note: we will modify subject when refresh ConversationHeaderItem in ConversationViewAdapter
    ...
    /**
     * mark the email's priority
     */
    public int flagPriority=1;
    ...
    public Conversation(Cursor cursor) {
        ...
        //[FEATURE]-Add-BEGIN by TSCD.chao zhang,04/17/2014,FR 631895(porting from FR514398)
        flagPriority=cursor.getInt(UIProvider.CONVERSATION_PRIORITY_FLAG_COLUMN);
        //[FEATURE]-Add-END by TSCD.chao zhang
    }
    ...
    public Conversation(Conversation other) {
        ...
        //[FEATURE]-Add-BEGIN by TSCD.chao zhang,04/17/2014,FR 631895(porting from FR514398)
        flagPriority = other.flagPriority;
        //[FEATURE]-Add-END by TSCD.chao zhang
    }
    ...
    public void applyCachedValues(ContentValues values) {
        ...
        for (String key : values.keySet()) {
            ...
            LogUtils.i(LOG_TAG, "Conversation: applying cached value to conId=%d col=%s val=%s",id,
                    key, val); // TS: zheng.zou 2015-1-18 EMAIL BUGFIX_1130225 MOD
    ...
    /*
     * get the current status's Display Strings
     */
    public String getStatusForDisplay(Context context) {
        switch (conversationInfo.status) {
            case EmailContent.Message.MAIL_IN_NONE_STATUS:
                return "";
            case EmailContent.Message.MAIL_IN_SENDING_STATUS:
                return context.getString(R.string.sending);
            case EmailContent.Message.MAIL_IN_QUEUE_STATUS:
                return context.getString(R.string.message_in_queued_status);
            case EmailContent.Message.MAIL_IN_FAILED_STATUS:
                return context.getString(R.string.message_failed);
        }
        return "";
    }

    /**
     * Judge which status string is the max length.
     * @param context
     * @return
     */
    public String getMaxLengthStatusDisplay(Context context) {
        return context.getString(R.string.sending);
    }
    /*
