...
public class Folder implements Parcelable, Comparable<Folder> {
    ...
    public static final class Builder {
        ...
        public Folder build() {
            return new Folder(mId, mPersistentId, mUri, mName, mCapabilities,
                    ...
                    mLastMessageTimestamp, mUnreadSenders, /*TCT: for local search*/mLocalSearchUri,mSyncTime,mAccountKey);
        }
        ...
        public Builder setSyncTime(final long syncTime) {
            mSyncTime = syncTime;
            return this;
        }
        public Builder setAccountKey(final long accountKey) {
    ...
    public Folder(int id, String persistentId, Uri uri, String name, int capabilities,
            ...
            final long lastMessageTimestamp, final String unreadSenders, Uri localSearchUri,long syncTime,long accountKey) {
        this.id = id;
    ...
    public Folder(Cursor cursor) {
        ...
        mSyncTime = cursor.getLong(UIProvider.FOLDER_SYNC_TIME_COLUMN);
        mAccountKey = cursor.getLong(UIProvider.FOLDER_ACCOUNT_KEY_COLUMN);
    }
    ...
    public static ObjectCursorLoader<Folder> forSearchResults(Account account, String query,
            /*TCT: add search field for remote search*/String field,String queryIdentifier, Context context) {
    ...
    public boolean isSyncInProgress() {
        ...
        return com.tct.mail.utils.UIProvider.SyncStatus.isSyncInProgress(syncStatus);
    }
    ...
    /**
     * TCT: Returns true if this folder is syncable.(outbox should be syncable in current designing
     concept)
     * return false, Draft and Virtual mailbox.
     */
    public boolean isSyncable() {
        return !isDraft() &&
        !supportsCapability(UIProvider.FolderCapabilities.IS_VIRTUAL);
    }
