...
import com.tct.mail.ui.AccountController;
 ...
 * registers with the observer with the {@link com.tct.mail.ui.AccountController} provided.
 * The object will then begin to receive {@link #onChanged(Account[])} till {@link
 * #unregisterAndDestroy()} is called. <p> To implement an {@link com.tct.mail.providers
...
public abstract class AllAccountObserver extends DataSetObserver {
     ...
     * {@link #initialize(com.tct.mail.ui.AccountController)} is called.
     */
    public AllAccountObserver() {
    }

    /**
     * Initializes an {@link com.tct.mail.providers.AllAccountObserver} object that receives
