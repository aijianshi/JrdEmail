...
public class UIProvider {
    /// TCT: Email provider authority @{
    public static final String EMAIL_PROVIDER_AUTHORITY = "com.tct.email.provider";
    /// @}
    ...
    public static int LOCAL_SEARCH_ALL = 0;
    public static int LOCAL_SEARCH_FROM = 1;
    public static int LOCAL_SEARCH_TO = 2;
    public static int LOCAL_SEARCH_SUBJECT = 3;
    //[FEATURE]-Add-END by TSCD.zhonghua.tuo
    // TS: xiaolin.li 2015-01-13 EMAIL BUGFIX-883410 DEL_S
    /**
...
//        }
//    }
    // TS: xiaolin.li 2015-01-13 EMAIL BUGFIX-883410 DEL_E
    ...
    public static final String AUTHORITY = "com.tct.mail.providers";

    public static final String ACCOUNT_LIST_TYPE =
            "vnd.android.cursor.dir/vnd.com.tct.mail.account";
    public static final String ACCOUNT_TYPE =
            "vnd.android.cursor.item/vnd.com.tct.mail.account";
    ...
    public static final String FLAG_FAVORITE_QUERY_PARAMETER = "flag_favorite";
    //TS: junwei-xu 2015-09-02 EMAIL BUGFIX-546917 ADD-E
    public static final String ORDER_QUERY_PARAMETER = "order";   //TS: zheng.zou 2016-1-14 EMAIL TASK_1431225 ADD
    ...
    public static final Map<String, Class<?>> ACCOUNTS_COLUMNS_NO_CAPABILITIES =
            ...
            .put(AccountColumns.SettingsColumns.REPLY_TO, String.class)//TS: zheng.zou 2016-03-21 EMAIL BUGFIX_1801683 ADD
            .build();
    ...
    public static final class AccountCapabilities {
        ...
        public static final int SMART_FORWARD = 0x1000000;   //TS: zheng.zou 2015-11-03 EMAIL BUGFIX_858353 ADD
    }
    ...
    public static final class AccountColumns implements BaseColumns {
        ...
        public static final class SettingsColumns {
            ...
            public static final String REPLY_TO = "reply_to";//TS: zheng.zou 2016-03-21 EMAIL BUGFIX_1801683 ADD
        }
    }
    ...
    public static final String FOLDER_LIST_TYPE =
            "vnd.android.cursor.dir/vnd.com.tct.mail.folder";
    public static final String FOLDER_TYPE =
            "vnd.android.cursor.item/vnd.com.tct.mail.folder";
    ...
    public static final String[] FOLDERS_PROJECTION = {
        ...
        FolderColumns.SYNC_TIME,
        FolderColumns.ACCOUNT_KEY
    };
    ...
    ///TCT: support local search.
    public static final int FOLDER_LOCALSEARCH_LIST_URI_COLUMN = 24;
    public static final int FOLDER_SYNC_TIME_COLUMN = 25;
    public static final int FOLDER_ACCOUNT_KEY_COLUMN = 26;
    ...
    public static final class FolderCapabilities {
         ...
         * {@link com.tct.mail.ui.MultiFoldersSelectionDialog}).
         */
    ...
    public static final class FolderColumns implements BaseColumns {
        ...
        ///TCT: add for local search, new Uri reference to 'conversationListUri'
    ...
    public static final String CONVERSATION_LIST_TYPE =
            "vnd.android.cursor.dir/vnd.com.tct.mail.conversation";
    public static final String CONVERSATION_TYPE =
            "vnd.android.cursor.item/vnd.com.tct.mail.conversation";
    ...
    public static final String[] CONVERSATION_PROJECTION = {
        ...
        ConversationColumns.FLAG_PRIORITY_COLUMN,//[FEATURE]-Add-BEGIN by TSCD.chao zhang,04/17/2014,FR 631895(porting from FR514398)
        ConversationColumns.MESSAGE_SIZE//TS: zheng.zou 2016-1-14 EMAIL TASK_1431225 ADD
    };
    ...
    public static final int CONVERSATION_PRIORITY_FLAG_COLUMN=27;//[FEATURE]-Add-BEGIN by TSCD.chao zhang,04/17/2014,FR 631895(porting from FR514398)

    public static final class ConversationSendingState {
        // TS: chao.zhang 2015-09-29 EMAIL FEATURE-585337 MOD_S
        //NOTE: reorder that can match the status's value in Message table.
    ...
    public static final class ConversationColumns {
        ...
        public static final String FLAG_PRIORITY_COLUMN = "flagPriority";//[FEATURE]-Add-BEGIN by TSCD.chao zhang,04/17/2014,FR 631895(porting from FR514398)
    ...
    public static final String[] MESSAGE_PROJECTION = {
        ...
        MessageColumns.MESSAGE_FLAG_PRIORITY_COLUMN,//[FEATURE]-Add-BEGIN by TSCD.chao zhang,04/17/2014,FR 631895(porting from FR514398)
        //TS: jian.xu 2015-11-03 EMAIL BUGFIX-845079 ADD_S
        MessageColumns.BODY_HTML_LINKIFY,
        MessageColumns.BODY_TEXT_LINKIFY,
        //TS: jian.xu 2015-11-03 EMAIL BUGFIX-845079 ADD_E
        //TS: Gantao 2015-12-01 EMAIL BUGFIX-1117109 ADD_S
        MessageColumns.MESSAGE_FLAG_LOADED
        //TS: Gantao 2015-12-01 EMAIL BUGFIX-1117109 ADD_E
    };
    ...
    public static final String MESSAGE_LIST_TYPE =
            "vnd.android.cursor.dir/vnd.com.tct.mail.message";
    public static final String MESSAGE_TYPE =
            "vnd.android.cursor.item/vnd.com.tct.mail.message";
    ...
    public static final int MESSAGE_FLAG_PRIORITY_COLUMN=38;//[FEATURE]-Add-BEGIN by TSCD.chao zhang,04/17/2014,FR 631895(porting from FR514398)
    //TS: jian.xu 2015-11-03 EMAIL BUGFIX-845079 ADD_S
    public static final int MESSAGE_BODY_HTML_LINKIFY_COLUMN=39;
    public static final int MESSAGE_BODY_TEXT_LINKIFY_COLUMN=40;
    //TS: jian.xu 2015-11-03 EMAIL BUGFIX-845079 ADD_E
    //TS: Gantao 2015-12-01 EMAIL BUGFIX-1117109 ADD_S
    public static final int MESSAGE_FLAG_LOADED_COLUMN=41;
    //TS: Gantao 2015-12-01 EMAIL BUGFIX-1117109 ADD_E
    ...
    public static final class CursorExtraKeys {
        ...
        /**
         * TCT: This boolean column contains the messages have load finished or not
         */
    ...
    public static final class MessageColumns {
         ...
         * {@link com.tct.ex.photo.provider.PhotoContract.PhotoViewColumns}.
         */
         ...
         * of being sent. See {@link com.tct.mail.providers.UIProvider.ConversationSendingState}
         */
        public static final String SENDING_STATE = "sendingState";
        /**
        ...
        /**
         * CONTENT_FLAG_PRIORITY_COLUMN
         */
        public static final String MESSAGE_FLAG_PRIORITY_COLUMN = "flagPriority";//[FEATURE]-Add-BEGIN by TSCD.chao zhang,04/17/2014,FR 631895(porting from FR514398)
        //TS: jian.xu 2015-11-03 EMAIL BUGFIX-845079 ADD_S
        /**
         * This string column contains the HTML form with Links of the message body, if available. If not,
         * a provider must populate BODY_TEXT.
         */
        public static final String BODY_HTML_LINKIFY = "bodyHtmlLinkify";
        /**
         * This string column contains the plaintext form with Links of the message body, if HTML is not
         * otherwise available. If HTML is available, this value should be left empty (null).
         */
        public static final String BODY_TEXT_LINKIFY = "bodyTextLinkify";
        //TS: jian.xu 2015-11-03 EMAIL BUGFIX-845079 ADD_E

        //TS: Gantao 2015-12-01 EMAIL BUGFIX-1117109 ADD_S
        /**
         * This string column contains the flag which indicate whether the message is download compl
         ete
         */
    ...
    public static final class MessageOperations {
     ...
     // TS: zhaotianyong 2015-02-04 EXCHANGE BUGFIX-923513 ADD_S
        public static final String RESPOND_CONTENT = "MESSAGE_BODY_TEXT_COLUMN";
    ...
    public static final String ATTACHMENT_LIST_TYPE =
            "vnd.android.cursor.dir/vnd.com.tct.mail.attachment";
    public static final String ATTACHMENT_TYPE =
            "vnd.android.cursor.item/vnd.com.tct.mail.attachment";
    ...
    //TS: zhonghua.tuo 2015-3-3 EMAIL BUGFIX_936728 ADD_S
    public static final int ATTACHMENT_REAL_URI_COLUMN = 14;
    //TS: zhonghua.tuo 2015-3-3 EMAIL BUGFIX_936728 ADD_E
 // TS: Gantao 2015-09-19 EMAIL BUGFIX_570084 ADD_S
    public static final int ATTACHMENT_ISINLINE_COLUMN = 15;
 // TS: Gantao 2015-09-19 EMAIL BUGFIX_570084 ADD_E
    ...
    public static final class AttachmentState {
        ...
        /**
         * The attachment is on the download queue but has not been started download, the state
         * will change to DOWNLOADING while start to download.
         */
        public static final int READYDOWNLOADING = 6;
    ...
    public static final class AttachmentColumns {
     ...
     // TS: Gantao 2015-09-19 EMAIL BUGFIX_570084 ADD_S
        /*
         * This column judge whether the attachment is inline attachment,but only use for pop/imap so far
         * 1->is inline; 0-> not inline
         */
    ...
    public static final String ACTION_UPDATE_NOTIFICATION =
            "com.tct.mail.action.update_notification";
