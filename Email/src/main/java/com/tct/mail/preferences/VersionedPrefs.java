 ...
 *BUGFIX-927191  2015/02/09   zhaotianyong    [Android5.0][Exchange]Email force close when sign in TCL account with "/" in user name
 ============================================================================ 
 */
...
public abstract class VersionedPrefs {
    ...
    protected VersionedPrefs(final Context context, final String sharedPrefsName) {
     ...
     // TS: zhaotianyong 2015-02-09 Email BUGFIX_927191 MOD_S
...
//        mSharedPreferences = context.getSharedPreferences(sharedPrefsName, Context.MODE_PRIVATE);
        String name = sharedPrefsName;
        mSharedPreferencesName = checkName(name);
        mSharedPreferences = context.getSharedPreferences(mSharedPreferencesName, Context.MODE_PRIVATE);
     // TS: zhaotianyong 2015-02-09 Email BUGFIX_927191 MOD_E
 ...
 // TS: zhaotianyong 2015-02-09 Email BUGFIX_927191 ADD_S
    private String checkName (String sharedPrefsName) {
        if (sharedPrefsName.contains("/")){
            sharedPrefsName = sharedPrefsName.replace("/", "-");
        }
        return sharedPrefsName;
    }
 // TS: zhaotianyong 2015-02-09 Email BUGFIX_927191 ADD_E
