...
public final class MailPrefs extends VersionedPrefs {
    ...
    public static final class PreferenceKeys {
        ...
        public static final String IGNORE_EXCHANGE_PERMISSION_CONTACT = "ignore-exchange-permission-contact";
        public static final String IGNORE_EXCHANGE_PERMISSION_CALENDAR = "ignore-exchange-permission-calendar";
        public static final String IGNORE_EXCHANGE_PERMISSION_STORAGE = "ignore-exchange-permission-storage";
        ...
        public static final ImmutableSet<String> BACKUP_KEYS =
                ...
                .add(Preferences.BCC_MYSELF_KEY)// TS: zhaotianyong 2014-12-02 EMAIL BUGFIX-855270 ADD
                .build();
    }
    ...
    public boolean getDefaultReplyAll() {
        // TS: Gantao 2016-01-19 EMAIL BUGFIX-1442836 MOD_S
        //Set the default return value : true
        return getSharedPreferences().getBoolean(PreferenceKeys.DEFAULT_REPLY_ALL, true);
        // TS: Gantao 2016-01-19 EMAIL BUGFIX-1442836 MOD_E
    }
    ...
    public boolean getConfirmDelete() {
        return getSharedPreferences().getBoolean(PreferenceKeys.CONFIRM_DELETE, true);//TS: yanhua.chen 2016-3-2 EMAIL BUGFIX_1715530 MOD
    }
    ...
    //TS: junwei-xu 2015-10-23 Email FEATURE-1099956 ADD_S
    public void setAutoDownloadRemaining(final boolean autoDownloadRemaining) {
        getEditor().putBoolean(PreferenceKeys.AUTO_DOWNLOAD_REMAINING, autoDownloadRemaining).apply();
        notifyBackupPreferenceChanged();
    }

    public boolean getAutoDownloadRemaining() {
        return getSharedPreferences().getBoolean(PreferenceKeys.AUTO_DOWNLOAD_REMAINING, false);
    }

    public void setAlwaysBccMyself(final boolean bccMyself) {
        getEditor().putBoolean(Preferences.BCC_MYSELF_KEY, bccMyself).apply();
        notifyBackupPreferenceChanged();
    }

    public boolean getAlwaysBccMyself() {
        return getSharedPreferences().getBoolean(Preferences.BCC_MYSELF_KEY, false);
    }
    //TS: junwei-xu 2015-10-23 Email FEATURE-1099956 ADD_E
    ...
    //TS: zheng.zou 2016-1-22 EMAIL BUGFIX-1431088 ADD_S
    public void setIgnoreExchangeContactPermission(boolean ignore){
        getEditor().putBoolean(PreferenceKeys.IGNORE_EXCHANGE_PERMISSION_CONTACT, ignore).apply();
    }

    public void setIgnoreExchangeCalendarPermission(boolean ignore){
        getEditor().putBoolean(PreferenceKeys.IGNORE_EXCHANGE_PERMISSION_CALENDAR, ignore).apply();
    }

    public void setIgnoreExchangeStoragePermission(boolean ignore){
        getEditor().putBoolean(PreferenceKeys.IGNORE_EXCHANGE_PERMISSION_STORAGE, ignore).apply();
    }

    public boolean getIgnoreExchangeContactPermission(){
        return getSharedPreferences().getBoolean(PreferenceKeys.IGNORE_EXCHANGE_PERMISSION_CONTACT,false);
    }

    public boolean getIgnoreExchangeCalendarPermission(){
        return getSharedPreferences().getBoolean(PreferenceKeys.IGNORE_EXCHANGE_PERMISSION_CALENDAR,false);
    }

    public boolean getIgnoreExchangeStoragePermission(){
        return getSharedPreferences().getBoolean(PreferenceKeys.IGNORE_EXCHANGE_PERMISSION_STORAGE,false);
    }
    //TS: zheng.zou 2016-1-22 EMAIL BUGFIX-1431088 ADD_E
}
