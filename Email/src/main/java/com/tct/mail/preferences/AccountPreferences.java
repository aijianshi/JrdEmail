...
public class AccountPreferences extends VersionedPrefs {
    ...
    public static final class PreferenceKeys {
        ...
        public static final String ENABLE_MANUAL_SYNC_WHEN_ROAMING = "enable-manual-sync-when-roaming";  //TS: jin.dong 2015-12-29 EMAIL FEATURE_1125784 ADD
    ...
    public void setManualSyncWhenRoamingEnabled(boolean enableManual){
        getEditor().putBoolean(PreferenceKeys.ENABLE_MANUAL_SYNC_WHEN_ROAMING, enableManual).apply();
    }

    public boolean getManualSyncWhenRoamingEnabled(){
      return  getSharedPreferences().getBoolean(PreferenceKeys.ENABLE_MANUAL_SYNC_WHEN_ROAMING, false);
    }
